...
export const ProductDetail: React.FC<Props> = ({description, screen, resolution, capacity, ram}) => {
    return (
            ...
            <div className="ProductDetail__about">
                ...
                <div className="ProductDetail__about-main">
                    {description.map((section, index) => (
                        <div key={index} className="ProductDetail__about-main">
                            <h4 className="ProductDetail__about-main-title">
                                {section.title}
                            </h4>

                            {section.text.map((paragraph, i) => (
                                <span key={i} className="ProductDetail__about-main-second">
                  {paragraph}
                </span>
                            ))}
                        </div>
