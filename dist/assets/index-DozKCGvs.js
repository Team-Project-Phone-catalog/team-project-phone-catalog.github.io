...
var Wm;
function Gg() {
  return (Wm || ((Wm = 1), (vo.exports = Ug())), vo.exports);
}
var v = Gg(),
  go = { exports: {} },
  ti = {},
    ...
    Im ||
      ...
      (function (a) {
        ...
        function i(G) {
          ...
          if (X !== Z) {
            G[0] = X;
            e: for (var ee = 0, oe = G.length, z = oe >>> 1; ee < z; ) {
              var k = 2 * (ee + 1) - 1,
                W = G[k],
                le = k + 1,
                de = G[le];
        ...
        var I = !1,
          ...
          ne = -1;
        function J() {
          return M ? !0 : !(a.unstable_now() - ne < H);
        }
        function F() {
          if (((M = !1), I)) {
            ...
            try {
              e: {
                ((j = !1), T && ((T = !1), E(K), (K = -1)), (S = !0));
                var X = A;
                try {
                  t: {
                    for (
                      V(G), y = s(d);
                      y !== null && !(y.expirationTime > G && J());
                    ) {
                      var ee = y.callback;
                      if (typeof ee == 'function') {
                        ((y.callback = null), (A = y.priorityLevel));
                        var oe = ee(y.expirationTime <= G);
                        if (((G = a.unstable_now()), typeof oe == 'function')) {
                          ((y.callback = oe), V(G), (Z = !0));
                          break t;
                        }
                        (y === s(d) && i(d), V(G));
                      } else i(d);
...
var eh;
function Yg() {
  return (eh || ((eh = 1), (yo.exports = qg())), yo.exports);
}
var bo = { exports: {} },
  ce = {};
var th;
function Vg() {
  ...
  ((x.prototype.isReactComponent = {}),
    (x.prototype.setState = function (z, k) {
    ...
    (x.prototype.forceUpdate = function (z) {
  ...
  var V = (D.prototype = new E());
  ((V.constructor = D), T(V, x.prototype), (V.isPureReactComponent = !0));
  var $ = Array.isArray;
  function I() {}
        ...
        switch (
          ...
          : ((z.status = 'pending'),
            z.then(
              function (k) {
                z.status === 'pending' &&
                  ((z.status = 'fulfilled'), (z.value = k));
              },
              function (k) {
                z.status === 'pending' &&
                  ((z.status = 'rejected'), (z.reason = k));
              },
            )),
          z.status)
        ) {
  ...
  function G(z, k, W, le, de) {
    var ve = typeof z;
    (ve === 'undefined' || ve === 'boolean') && (z = null);
    var Ce = !1;
    if (z === null) Ce = !0;
    else
      switch (ve) {
        ...
        case 'object':
          switch (z.$$typeof) {
            ...
            case r:
              ...
              break;
            case b:
              return ((Ce = z._init), G(Ce(z._payload), k, W, le, de));
          }
      }
    if (Ce)
      return (
    ...
    if ($(z))
      for (var Ue = 0; Ue < z.length; Ue++)
        ((le = z[Ue]), (ve = st + re(le, Ue)), (Ce += G(le, k, W, ve, de)));
    else if (((Ue = S(z)), typeof Ue == 'function'))
      for (z = Ue.call(z), Ue = 0; !(le = z.next()).done; )
        ((le = le.value),
          (ve = st + re(le, Ue++)),
          (Ce += G(le, k, W, ve, de)));
    else if (ve === 'object') {
      if (typeof z.then == 'function') return G(pe(z), k, W, le, de);
      throw (
        (k = String(z)),
        Error(
        ...
        k.then(
          function (W) {
            (z._status === 0 || z._status === -1) &&
              ((z._status = 1), (z._result = W));
          },
          function (W) {
            (z._status === 0 || z._status === -1) &&
              ((z._status = 2), (z._result = W));
          },
        ),
  ...
  return (
    ...
    (ce.cloneElement = function (z, k, W) {
      if (z == null)
        throw Error(
    ...
    (ce.createContext = function (z) {
      return (
        ...
        (z.Provider = z),
        (z.Consumer = { $$typeof: f, _context: z }),
        z
      );
    }),
    (ce.createElement = function (z, k, W) {
      var le,
        de = {},
        ve = null;
      if (k != null)
      ...
      if (z && z.defaultProps)
        for (le in ((Ce = z.defaultProps), Ce))
    ...
    (ce.isValidElement = F),
    (ce.lazy = function (z) {
      return { $$typeof: b, _payload: { _status: -1, _result: z }, _init: X };
    }),
    (ce.memo = function (z, k) {
      return { $$typeof: p, type: z, compare: k === void 0 ? null : k };
    }),
    (ce.startTransition = function (z) {
      ...
      try {
        ...
        (k !== null && W.types !== null && (k.types = W.types), (K.T = k));
      }
    }),
    ...
    (ce.useActionState = function (z, k, W) {
      return K.H.useActionState(z, k, W);
    }),
    (ce.useCallback = function (z, k) {
      return K.H.useCallback(z, k);
    }),
    (ce.useContext = function (z) {
      return K.H.useContext(z);
    }),
    (ce.useDebugValue = function () {}),
    (ce.useDeferredValue = function (z, k) {
      return K.H.useDeferredValue(z, k);
    }),
    (ce.useEffect = function (z, k) {
      return K.H.useEffect(z, k);
    }),
    ...
    (ce.useImperativeHandle = function (z, k, W) {
      return K.H.useImperativeHandle(z, k, W);
    }),
    (ce.useInsertionEffect = function (z, k) {
      return K.H.useInsertionEffect(z, k);
    }),
    (ce.useLayoutEffect = function (z, k) {
      return K.H.useLayoutEffect(z, k);
    }),
    (ce.useMemo = function (z, k) {
      return K.H.useMemo(z, k);
    }),
    (ce.useOptimistic = function (z, k) {
      return K.H.useOptimistic(z, k);
    }),
    (ce.useReducer = function (z, k, W) {
      return K.H.useReducer(z, k, W);
    }),
    ...
    (ce.useSyncExternalStore = function (z, k, W) {
      return K.H.useSyncExternalStore(z, k, W);
    }),
...
var lh;
function Uo() {
  return (lh || ((lh = 1), (bo.exports = Vg())), bo.exports);
}
var So = { exports: {} },
  it = {};
var ah;
...
function Qg() {
  ...
  return (a(), (So.exports = Xg()), So.exports);
}
var ih;
function Zg() {
  if (ih) return ti;
...
`);
        ...
        for (; u < L.length && !L[u].includes('DetermineComponentFrameRoot'); )
          u++;
        if (n === C.length || u === L.length)
          for (
            n = C.length - 1, u = L.length - 1;
            1 <= n && 0 <= u && C[n] !== L[u];
          )
            u--;
        for (; 1 <= n && 0 <= u; n--, u--)
...
` + C[n].replace(' at new ', ' at ');
      ...
      ((Ws = !1), (Error.prepareStackTrace = l));
    }
...
` +
  ...
  var er = Object.prototype.hasOwnProperty,
    ...
    vp = a.unstable_shouldYield,
    gp = a.unstable_requestPaint,
    gt = a.unstable_now,
    yp = a.unstable_getCurrentPriorityLevel,
    Po = a.unstable_ImmediatePriority,
    Wo = a.unstable_UserBlockingPriority,
    hi = a.unstable_NormalPriority,
    _p = a.unstable_LowPriority,
  ...
  var _t = Math.clz32 ? Math.clz32 : Ep,
    xp = Math.log,
    Tp = Math.LN2;
  function Ep(e) {
    return ((e >>>= 0), e === 0 ? 32 : (31 - ((xp(e) / Tp) | 0)) | 0);
  }
  var pi = 256,
    vi = 262144,
    gi = 4194304;
  ...
  var bl = Math.random().toString(36).slice(2),
    ...
    sr = '__reactEvents$' + bl,
    Ap = '__reactListeners$' + bl,
    Np = '__reactHandles$' + bl,
    sc = '__reactResources$' + bl,
    fn = '__reactMarker$' + bl;
  function rr(e) {
    (delete e[We], delete e[ct], delete e[sr], delete e[Ap], delete e[Np]);
  }
  function _a(e) {
    var t = e[We];
    if (t) return t;
  ...
  var Dp = /[\n"\\]/g;
  function zt(e) {
    return e.replace(Dp, function (t) {
      return '\\' + t.charCodeAt(0).toString(16) + ' ';
    });
  }
  function or(e, t, l, n, u, o, m, _) {
    ((e.name = ''),
      (
        m != null &&
        typeof m != 'function' &&
  ...
  function Ta(e, t, l, n) {
    if (((e = e.options), t)) {
      ...
      for (l = '' + Nt(l), t = null, u = 0; u < e.length; u++) {
        if (e[u].value === l) {
    ...
    if (((e = e.style), l != null)) {
      for (var n in l)
        !l.hasOwnProperty(n) ||
          ...
          : (e[n] = ''));
      for (var u in t)
        ((n = t[u]), t.hasOwnProperty(u) && l[u] !== n && vc(e, u, n));
  ...
  function _c(e, t, l) {
    ...
    try {
      ...
      if (
        ((hr = !1),
        (Ca !== null || Ma !== null) &&
          (os(), Ca && ((t = Ca), (e = Ma), (Ma = Ca = null), yc(t), e)))
      )
  ...
  var Fl = {
    ...
    xc = ft(Ai),
    Hp = y({}, Ai, { dataTransfer: 0 }),
    Up = ft(Hp),
    Gp = y({}, pn, { relatedTarget: 0 }),
    _r = ft(Gp),
    qp = y({}, Fl, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Yp = ft(qp),
    Vp = y({}, Fl, {
  ...
  var Jp = y({}, pn, {
    ...
    Ip = ft(Wp),
    ev = y({}, Fl, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    tv = ft(ev),
    lv = y({}, Ai, {
      deltaX: function (e) {
        return (
  ...
  function ov(e, t) {
    if (Aa)
      return e === 'compositionend' || (!Sr && Nc(e, t)) ?
          ((e = bc()), (Ti = vr = Sl = null), (Aa = !1), e)
        : null;
    switch (e) {
      case 'paste':
        return null;
    ...
    if (It) {
      ...
      if (!Tr) {
        ...
        (wc.setAttribute('oninput', 'return;'),
          (Tr = typeof wc.oninput == 'function'));
      }
      xr = Tr;
    } else xr = !1;
    Rc = xr && (!document.documentMode || 9 < document.documentMode);
  }
  function Lc() {
    yn && (yn.detachEvent('onpropertychange', Bc), (_n = yn = null));
  }
  function Bc(e) {
    if (e.propertyName === 'value' && Ni(_n)) {
      var t = [];
      (jc(t, _n, e, mr(e)), _c(fv, t));
    }
  }
  function dv(e, t, l) {
    e === 'focusin' ?
      (Lc(), (yn = t), (_n = l), yn.attachEvent('onpropertychange', Bc))
    : e === 'focusout' && Lc();
  }
  function mv(e) {
  ...
  var bt = typeof Object.is == 'function' ? Object.is : vv;
  function bn(e, t) {
    if (bt(e, t)) return !0;
    if (
      typeof e != 'object' ||
    ...
    for (n = 0; n < l.length; n++) {
      var u = l[n];
      if (!er.call(t, u) || !bt(e[u], t[u])) return !1;
    }
    return !0;
  }
  function Hc(e) {
  ...
  function Gc(e, t) {
    return (
      e && t ?
        e === t ? !0
        : e && e.nodeType === 3 ? !1
        : t && t.nodeType === 3 ? Gc(e, t.parentNode)
  ...
  var gv = It && 'documentMode' in document && 11 >= document.documentMode,
    Na = null,
    Cr = null,
    Sn = null,
    Mr = !1;
  ...
  function Wl(e) {
    ...
    var t = za[e],
      l;
    for (l in t) if (t.hasOwnProperty(l) && l in Vc) return (Ar[e] = t[l]);
    return e;
  }
  var Xc = Wl('animationend'),
    Qc = Wl('animationiteration'),
    Zc = Wl('animationstart'),
    yv = Wl('transitionrun'),
    _v = Wl('transitionstart'),
    bv = Wl('transitioncancel'),
    kc = Wl('transitionend'),
    $c = new Map(),
    Nr =
  ...
  function Ri(e, t, l, n, u, o) {
    var m = 0;
    if (((n = e), typeof e == 'function')) jr(e) && (m = 1);
    else if (typeof e == 'string')
      m =
        Mg(e, l, le.current) ? 26
  ...
  function jt(e, t) {
    if (typeof e == 'object' && e !== null) {
      var l = Pc.get(e);
      return l !== void 0 ? l : (
          ((t = { value: e, source: t, stack: Fo(t) }), Pc.set(e, t), t)
        );
    }
    return { value: e, source: t, stack: Fo(t) };
  }
  var Da = [],
    Ra = 0,
    wi = null,
  ...
  function Lr(e) {
    for (; e === wi; )
      ((wi = Da[--Ra]), (Da[Ra] = null), (xn = Da[--Ra]), (Da[Ra] = null));
    for (; e === xl; )
      ((xl = Dt[--Rt]),
        (Dt[Rt] = null),
        (Zt = Dt[--Rt]),
  ...
  function ef(e) {
    ...
    switch (((t[We] = e), (t[ct] = n), l)) {
      ...
      case 'select':
        ...
        break;
      case 'textarea':
        (ye('invalid', t), pc(t, n.value, n.defaultValue, n.children));
    }
    ((l = n.children),
      (
        (typeof l != 'string' &&
  ...
  function wa(e) {
    ...
    if (
      ...
      : (De = Ie ? Bt(e.stateNode.nextSibling) : null);
    return !0;
  }
  function ta() {
    ((De = Ie = null), (Se = !1));
  ...
  var Ur = z(null),
    ...
    ll = null;
  function Cl(e, t, l) {
    (W(Ur, t._currentValue), (t._currentValue = l));
  }
  function al(e) {
  ...
  function qi(e) {
    var t = Mn;
    return ((Mn += 1), Ga === null && (Ga = []), uf(Ga, e, t));
  }
  function An(e, t) {
  ...
  function ff(e) {
    function t(R, O) {
      if (e) {
        var w = R.deletions;
        w === null ? ((R.deletions = [O]), (R.flags |= 16)) : w.push(O);
      }
    }
    function l(R, O) {
      if (!e) return null;
    ...
    function u(R, O) {
      return ((R = el(R, O)), (R.index = 0), (R.sibling = null), R);
    }
    function o(R, O, w) {
      return (
        (R.index = w),
        e ?
          ((w = R.alternate),
          w !== null ?
            ((w = w.index), w < O ? ((R.flags |= 67108866), O) : w)
          : ((R.flags |= 67108866), O))
        : ((R.flags |= 1048576), O)
      );
    }
    ...
    function _(R, O, w, Y) {
      return O === null || O.tag !== 6 ?
          ((O = Dr(w, R.mode, Y)), (O.return = R), O)
        : ((O = u(O, w)), (O.return = R), O);
    }
    function C(R, O, w, Y) {
      var ie = w.type;
      return (
        ie === T ? q(R, O, w.props.children, Y, w.key)
        : (
          O !== null &&
          (O.elementType === ie ||
            (typeof ie == 'object' &&
          ...
          ((O = u(O, w.props)), An(O, w), (O.return = R), O)
        : ((O = Ri(w.type, w.key, w.props, null, R.mode, Y)),
          An(O, w),
          (O.return = R),
          O)
      );
    ...
    function L(R, O, w, Y) {
      return (
          O === null ||
            O.tag !== 4 ||
            O.stateNode.containerInfo !== w.containerInfo ||
            O.stateNode.implementation !== w.implementation
        ) ?
          ((O = Rr(w, R.mode, Y)), (O.return = R), O)
        : ((O = u(O, w.children || [])), (O.return = R), O);
    }
    function q(R, O, w, Y, ie) {
      return O === null || O.tag !== 7 ?
          ((O = ea(w, R.mode, Y, ie)), (O.return = R), O)
        : ((O = u(O, w)), (O.return = R), O);
    }
    function Q(R, O, w) {
      if (
        ...
        return ((O = Dr('' + O, R.mode, w)), (O.return = R), O);
      if (typeof O == 'object' && O !== null) {
        switch (O.$$typeof) {
          case S:
            return (
              (w = Ri(O.type, O.key, O.props, null, R.mode, w)),
              An(w, O),
              (w.return = R),
              w
            );
          case j:
            return ((O = Rr(O, R.mode, w)), (O.return = R), O);
          case H:
            return ((O = ia(O)), Q(R, O, w));
        }
        if (pe(O) || P(O))
          return ((O = ea(O, R.mode, w, null)), (O.return = R), O);
        if (typeof O.then == 'function') return Q(R, qi(O), w);
        if (O.$$typeof === D) return Q(R, Bi(R, O), w);
        Yi(R, O);
      }
      return null;
    }
    function B(R, O, w, Y) {
      ...
      if (
        ...
        return ie !== null ? null : _(R, O, '' + w, Y);
      if (typeof w == 'object' && w !== null) {
        switch (w.$$typeof) {
          case S:
            return w.key === ie ? C(R, O, w, Y) : null;
          case j:
            return w.key === ie ? L(R, O, w, Y) : null;
          case H:
            return ((w = ia(w)), B(R, O, w, Y));
        }
        if (pe(w) || P(w)) return ie !== null ? null : q(R, O, w, Y, null);
        if (typeof w.then == 'function') return B(R, O, qi(w), Y);
        if (w.$$typeof === D) return B(R, O, Bi(R, w), Y);
        Yi(R, w);
      }
      return null;
    }
    function U(R, O, w, Y, ie) {
      if (
        (typeof Y == 'string' && Y !== '') ||
        typeof Y == 'number' ||
        typeof Y == 'bigint'
      )
        return ((R = R.get(w) || null), _(O, R, '' + Y, ie));
      if (typeof Y == 'object' && Y !== null) {
        switch (Y.$$typeof) {
          ...
          case H:
            return ((Y = ia(Y)), U(R, O, w, Y, ie));
        }
        if (pe(Y) || P(Y))
          return ((R = R.get(w) || null), q(O, R, Y, ie, null));
        if (typeof Y.then == 'function') return U(R, O, w, qi(Y), ie);
        if (Y.$$typeof === D) return U(R, O, w, Bi(O, Y), ie);
        Yi(O, Y);
      }
      return null;
    }
    function te(R, O, w, Y) {
      for (
        var ie = null, xe = null, ae = O, he = (O = 0), be = null;
        ae !== null && he < w.length;
        he++
      ) {
        ae.index > he ? ((be = ae), (ae = null)) : (be = ae.sibling);
        var Te = B(R, ae, w[he], Y);
        if (Te === null) {
          ae === null && (ae = be);
          break;
        }
      ...
      if (he === w.length) return (l(R, ae), Se && tl(R, he), ie);
      if (ae === null) {
        for (; he < w.length; he++)
          ((ae = Q(R, w[he], Y)),
            ae !== null &&
    ...
    function se(R, O, w, Y) {
      ...
      for (ae = n(ae); !Te.done; he++, Te = w.next())
    ...
    function Oe(R, O, w, Y) {
      if (
        ...
        switch (w.$$typeof) {
          case S:
            e: {
              for (var ie = w.key; O !== null; ) {
                if (O.key === ie) {
                  if (((ie = w.type), ie === T)) {
                    if (O.tag === 7) {
                      (l(R, O.sibling),
                        (Y = u(O, w.props.children)),
                        (Y.return = R),
                        (R = Y));
                      break e;
                    }
              ...
              w.type === T ?
                ...
                (Y.return = R),
                (R = Y))
              : ((Y = Ri(w.type, w.key, w.props, null, R.mode, Y)),
                An(Y, w),
                (Y.return = R),
                (R = Y));
            }
          ...
          case j:
            ...
            return m(R);
          case H:
            return ((w = ia(w)), Oe(R, O, w, Y));
        }
        if (pe(w)) return te(R, O, w, Y);
        if (P(w)) {
          if (((ie = P(w)), typeof ie != 'function')) throw Error(i(150));
          return ((w = ie.call(w)), se(R, O, w, Y));
        }
        if (typeof w.then == 'function') return Oe(R, O, qi(w), Y);
        if (w.$$typeof === D) return Oe(R, O, Bi(R, w), Y);
        Yi(R, w);
      }
      return (
          (typeof w == 'string' && w !== '') ||
          ...
          ((w = '' + w),
          O !== null && O.tag === 6 ?
            (l(R, O.sibling), (Y = u(O, w)), (Y.return = R), (R = Y))
          : (l(R, O), (Y = Dr(w, R.mode, Y)), (Y.return = R), (R = Y)),
          m(R))
        : l(R, O);
    }
    return function (R, O, w, Y) {
      try {
        Mn = 0;
        var ie = Oe(R, O, w, Y);
        return ((Ga = null), ie);
  ...
  function Nn(e, t, l) {
    if (
      ...
      var n = t.lanes;
      ((n &= e.pendingLanes), (l |= n), (t.lanes = l), lc(e, l));
    }
  }
  function $r(e, t) {
    var l = e.updateQueue,
  ...
  function On(e, t, l, n) {
    ...
    if (_ !== null) {
      ...
      var C = _,
        L = C.next;
      ((C.next = null), m === null ? (o = L) : (m.next = L), (m = C));
      var q = e.alternate;
      q !== null &&
        ((q = q.updateQueue),
        (_ = q.lastBaseUpdate),
        _ !== m &&
          (_ === null ? (q.firstBaseUpdate = L) : (_.next = L),
          (q.lastBaseUpdate = C)));
    }
    if (o !== null) {
      var Q = u.baseState;
  ...
  function hf(e, t) {
    var l = e.callbacks;
    if (l !== null)
      for (e.callbacks = null, e = 0; e < l.length; e++) mf(l[e], t);
  }
  var qa = z(null),
    Vi = z(0);
  function pf(e, t) {
  ...
  function Pr(e) {
    (W(Ge, Ge.current), W(xt, e), Lt === null && (Lt = e));
  }
  function vf(e) {
    e.tag === 22 ?
      (W(Ge, Ge.current), W(xt, e), Lt === null && (Lt = e))
  ...
  function Ir(e, t, l, n, u, o) {
    return (
      ...
      (t.updateQueue = null),
      (t.lanes = 0),
      (G.H = e === null || e.memoizedState === null ? If : hu),
      (ua = !1),
      (o = l(n, u)),
      (ua = !1),
      Ya && (o = yf(t, l, n, u)),
  ...
  function gf(e) {
    ...
    if (((nl = 0), (Xe = Ne = me = null), (Qi = !1), (jn = 0), (Va = null), t))
      throw Error(i(300));
    e === null ||
      Qe ||
      ((e = e.dependencies), e !== null && Li(e) && (Qe = !0));
  }
  function yf(e, t, l, n) {
    me = e;
    var u = 0;
  ...
  function Nv() {
    ...
    return (
      ...
      (e = e.useState()[0]),
      (Ne !== null ? Ne.memoizedState : null) !== e && (me.flags |= 1024),
      t
    );
  }
  function eu() {
  ...
  function lu(e) {
    ...
    ((nl = 0), (Xe = Ne = me = null), (Ya = !1), (jn = Zi = 0), (Va = null));
  }
  function rt() {
    var e = {
      memoizedState: null,
  ...
  function Dn(e) {
    ...
    return (
      ...
      (Xe === null ? t.memoizedState : Xe.next) === null &&
        ((t = t.alternate),
        (G.H = t === null || t.memoizedState === null ? If : hu)),
      e
    );
  }
  function $i(e) {
  ...
  function _f(e, t, l) {
    ...
    var m = !bt((Ne || u).memoizedState, l);
    if (
      (m && ((u.memoizedState = l), (Qe = !0)),
      (u = u.queue),
      uu(xf.bind(null, n, u, e), [e]),
      u.getSnapshot !== t || m || (Xe !== null && Xe.memoizedState.tag & 1))
    ) {
      if (
        ((n.flags |= 2048),
        Xa(9, { destroy: void 0 }, Sf.bind(null, n, u, l, t), null),
        je === null)
      )
        throw Error(i(349));
      o || (nl & 127) !== 0 || bf(n, t, l);
  ...
  function bf(e, t, l) {
    ((e.flags |= 16384),
      ...
      (t = me.updateQueue),
      t === null ?
        ((t = ki()), (me.updateQueue = t), (t.stores = [e]))
      : ((l = t.stores), l === null ? (t.stores = [e]) : l.push(e)));
  }
  function Sf(e, t, l, n) {
    ((t.value = l), (t.getSnapshot = n), Tf(t) && Ef(e));
  }
  function xf(e, t, l) {
    return l(function () {
      Tf(t) && Ef(e);
  ...
  function Cf(e, t, l, n) {
    return ((e.baseState = l), nu(e, Ne, typeof n == 'function' ? n : il));
  }
  function zv(e, t, l, n, u) {
  ...
  function Nf(e, t, l) {
    ((t.status = 'fulfilled'),
      ...
      t !== null &&
        ((l = t.next),
        l === t ? (e.pending = null) : ((l = l.next), (t.next = l), Mf(e, l))));
  }
  function ru(e, t, l) {
    var n = e.pending;
    if (((e.pending = null), n !== null)) {
      n = n.next;
      do ((t.status = 'rejected'), (t.reason = l), zf(t), (t = t.next));
      while (t !== n);
    }
    e.action = null;
  }
  ...
  function jf(e, t) {
    ...
    return (
      ...
      (n.dispatch = l),
      (n = su(!1)),
      (o = mu.bind(null, me, !1, n.queue)),
      (n = rt()),
      (u = { state: t, dispatch: null, action: e, pending: null }),
      (n.queue = u),
      (l = zv.bind(null, me, u, o, l)),
      (u.dispatch = l),
      (n.memoizedState = e),
      [t, l, !1]
    );
  ...
  function Rf(e, t, l) {
    ...
    return (
      l !== t.memoizedState &&
        ((me.flags |= 2048),
        Xa(9, { destroy: void 0 }, Ov.bind(null, u, l), null)),
      [n, o, e]
    );
  }
  function Ov(e, t) {
  ...
  function Fi(e, t, l, n) {
    ...
    Ne !== null && n !== null && Wr(n, Ne.memoizedState.deps) ?
  ...
  function jv(e) {
    ...
    if (t === null) ((t = ki()), (me.updateQueue = t), (t.events = [e]));
    else {
      var l = t.events;
  ...
  function Yf(e, t, l) {
    ((l = l != null ? l.concat([e]) : null), Fi(4, 4, qf.bind(null, t, e), l));
  }
  function ou() {}
  function Vf(e, t) {
    var l = qe();
  ...
  function cu(e, t, l) {
    return l === void 0 || ((nl & 1073741824) !== 0 && (_e & 261930) === 0) ?
        (e.memoizedState = t)
      : ((e.memoizedState = l), (e = Qd()), (me.lanes |= e), (Rl |= e), l);
  }
  function Qf(e, t, l, n) {
    return (
      bt(l, t) ? l
      : qa.current !== null ? ((e = cu(e, l, n)), bt(e, t) || (Qe = !0), e)
      : (nl & 42) === 0 || ((nl & 1073741824) !== 0 && (_e & 261930) === 0) ?
        ((Qe = !0), (e.memoizedState = l))
      : ((e = Qd()), (me.lanes |= e), (Rl |= e), t)
    );
  }
  function Zf(e, t, l, n, u) {
    var o = Z.p;
    Z.p = o !== 0 && 8 > o ? o : 8;
    var m = G.T,
      _ = {};
  ...
  var If = {
      ...
      useImperativeHandle: function (e, t, l) {
        ((l = l != null ? l.concat([e]) : null),
          Ji(4194308, 4, qf.bind(null, t, e), l));
      },
      ...
      useSyncExternalStore: function (e, t, l) {
        ...
        return (
          (u.queue = o),
          Bf(xf.bind(null, n, o, e), [e]),
          (n.flags |= 2048),
          Xa(9, { destroy: void 0 }, Sf.bind(null, n, o, l, t), null),
          l
        );
      },
      useId: function () {
        ...
        if (Se) {
          ...
          ((l = (n & ~(1 << (32 - _t(n) - 1))).toString(32) + l),
            ...
            (t += '_'));
        } else ((l = Av++), (t = '_' + t + 'r_' + l.toString(32) + '_'));
      ...
      useCacheRefresh: function () {
        return (rt().memoizedState = Rv.bind(null, me));
      },
  ...
  var ed = {
    ...
    useDeferredValue: function (e, t) {
      var l = qe();
      return Ne === null ? cu(l, e, t) : Qf(l, Ne.memoizedState, e, t);
    },
    useTransition: function () {
      var e = iu(il)[0],
        t = qe().memoizedState;
  ...
  var vu = {
    ...
    enqueueForceUpdate: function (e, t) {
      ...
      ((n.tag = 2),
        t != null && (n.callback = t),
        (t = Nl(e, n, l)),
        t !== null && (vt(t, e, l), Nn(t, e, l)));
    },
  };
  function td(e, t, l, n, u, o, m) {
    return (
      (e = e.stateNode),
    ...
    if (
      ...
      if (
        ...
        switch (l.tag) {
          ...
          case 13:
            return (
              Lt === null ? cs() : l.alternate === null && He === 0 && (He = 3),
              (l.flags &= -257),
              (l.flags |= 65536),
              (l.lanes = u),
              n === Gi ?
    ...
    if (Se)
      return (
        ...
        t !== null ?
          ...
          (t.flags |= 65536),
          (t.lanes = u),
          n !== Br && ((e = Error(i(422), { cause: n })), Tn(jt(e, l))))
        : (n !== Br && ((t = Error(i(423), { cause: n })), Tn(jt(t, l))),
  ...
  var yu = Error(i(461)),
    Qe = !1;
  function tt(e, t, l, n) {
    t.child = e === null ? df(t, null, l, n) : ra(t, e.child, l, n);
  }
  function od(e, t, l, n, u) {
    ...
    return (
      ...
      e !== null && !Qe ?
        (tu(e, t, u), sl(e, t, u))
      : (Se && _ && wr(t), (t.flags |= 1), tt(e, t, n, u), t.child)
    );
  }
  function cd(e, t, l, n, u) {
    if (e === null) {
      ...
      return (
          ...
          ((t.tag = 15), (t.type = o), fd(e, t, o, n, u))
  ...
  function dd(e, t, l, n) {
    ...
    if (
      ...
      if ((l & 536870912) !== 0)
        ...
        return (
          (n = t.lanes = 536870912),
          md(e, t, o !== null ? o.baseLanes | l : l, l, n)
        );
    } else
      o !== null ?
        (Hi(t, o.cachePool), pf(t, o), Ol(), (t.memoizedState = null))
      : (e !== null && Hi(t, null), Jr(), Ol());
  ...
  function Bv(e, t, l) {
    ...
    if (((t.flags &= -129), e === null)) {
      if (Se) {
        if (n.mode === 'hidden')
          return ((e = Ii(t, n)), (t.lanes = 536870912), Ln(null, e));
        if (
          (Pr(t),
          (e = De) ?
            ((e = Mm(e, wt)),
    ...
    if (o !== null) {
      ...
      if ((Pr(t), u))
        ...
        if (
          ((n = je),
          n !== null && ((m = ac(n, l)), m !== 0 && m !== o.retryLane))
        )
          throw ((o.retryLane = m), Il(e, m), vt(n, e, m), yu);
        (cs(), (t = hd(e, t, l)));
      } else
        ((e = o.treeContext),
          (De = Bt(m.nextSibling)),
  ...
  function _u(e, t, l, n, u) {
    return (
      ...
      e !== null && !Qe ?
        (tu(e, t, u), sl(e, t, u))
      : (Se && n && wr(t), (t.flags |= 1), tt(e, t, l, u), t.child)
    );
  }
  function pd(e, t, l, n, u, o) {
    return (
      aa(t),
      (t.updateQueue = null),
      (l = yf(t, n, l, u)),
      ...
      e !== null && !Qe ?
        (tu(e, t, o), sl(e, t, o))
      : (Se && n && wr(t), (t.flags |= 1), tt(e, t, l, o), t.child)
    );
  }
  function vd(e, t, l, n, u) {
    if ((aa(t), t.stateNode === null)) {
      ...
      (typeof m == 'object' && m !== null && (o = et(m)),
        ...
        Zr(t),
        (m = l.contextType),
        (o.context = typeof m == 'object' && m !== null ? et(m) : ja),
        (o.state = t.memoizedState),
        (m = l.getDerivedStateFromProps),
        typeof m == 'function' && (pu(t, l, m, n), (o.state = t.memoizedState)),
        typeof l.getDerivedStateFromProps == 'function' ||
          ...
          m !== o.state && vu.enqueueReplaceState(o, o.state, null),
          On(t, n, o, u),
          zn(),
          (o.state = t.memoizedState)),
      ...
      var L = o.context,
        q = l.contextType;
      ((m = ja), typeof q == 'object' && q !== null && (m = et(q)));
      ...
      (
        ...
        (typeof _ == 'function' && (pu(t, l, _, n), (U = t.memoizedState)),
        (
          (q =
            Ml ||
            td(t, l, q, n, B, U, C) ||
          ...
          (L ||
            ...
            (typeof o.componentWillUpdate == 'function' &&
              o.componentWillUpdate(n, U, C),
            typeof o.UNSAFE_componentWillUpdate == 'function' &&
              o.UNSAFE_componentWillUpdate(n, U, C)),
  ...
  function gd(e, t, l, n) {
    return (ta(), (t.flags |= 256), tt(e, t, l, n), t.child);
  }
  var bu = {
    dehydrated: null,
    treeContext: null,
  ...
  function yd(e, t, l) {
    ...
    if (C !== null && ((_ = C.dehydrated), _ !== null)) {
      if (o)
        t.flags & 256 ? (zl(t), (t.flags &= -257), (t = Eu(e, t, l)))
        : t.memoizedState !== null ?
        ...
        if (((m = _.nextSibling && _.nextSibling.dataset), m)) var L = m.dgst;
        ((m = L),
          (n = Error(i(419))),
          (n.stack = ''),
          (n.digest = m),
        ...
        (Qe || La(e, t, l, !1), (m = (l & e.childLanes) !== 0), Qe || m)
      ) {
        if (
          ((m = je),
          m !== null && ((n = ac(m, l)), n !== 0 && n !== C.retryLane))
        )
          throw ((C.retryLane = n), Il(e, n), vt(m, e, n), yu);
        (ao(_) || cs(), (t = Eu(e, t, l)));
      } else
        ao(_) ?
    ...
    return u ?
        ...
        (C = e.child),
        (L = C.sibling),
        (n = el(C, { mode: 'hidden', children: n.children })),
        (n.subtreeFlags = C.subtreeFlags & 65011712),
        L !== null ? (_ = el(L, _)) : ((_ = ea(_, u, l, null)), (_.flags |= 2)),
        (_.return = t),
        (n.return = t),
        (n.sibling = _),
        (t.child = n),
  ...
  function bd(e, t, l) {
    ...
    if (
      ...
      e: for (e = t.child; e !== null; ) {
        if (e.tag === 13) e.memoizedState !== null && _d(e, l, t);
        else if (e.tag === 19) _d(e, l, t);
  ...
  function Hv(e, t, l) {
    switch (t.tag) {
      ...
      case 13:
        ...
        if (n !== null)
          return (
            n.dehydrated !== null ? (zl(t), (t.flags |= 128), null)
            : (l & t.child.childLanes) !== 0 ? yd(e, t, l)
            : (zl(t), (e = sl(e, t, l)), e !== null ? e.sibling : null)
          );
        zl(t);
        break;
      case 19:
        ...
        return null;
      case 22:
        return ((t.lanes = 0), dd(e, t, l, t.pendingProps));
      case 24:
        Cl(t, Ve, e.memoizedState.cache);
    }
    return sl(e, t, l);
  ...
  function Sd(e, t, l) {
    if (e !== null)
      if (e.memoizedProps !== t.pendingProps) Qe = !0;
        ...
        if (!Mu(e, l) && (t.flags & 128) === 0) return ((Qe = !1), Hv(e, t, l));
        Qe = (e.flags & 131072) !== 0;
      }
    ...
    switch (((t.lanes = 0), t.tag)) {
      case 16:
        e: {
          ...
          if (((e = ia(t.elementType)), (t.type = e), typeof e == 'function'))
            jr(e) ?
              ((n = oa(e, n)), (t.tag = 1), (t = vd(null, t, e, n, l)))
            : ((t.tag = 0), (t = _u(null, t, e, n, l)));
          else {
            if (e != null) {
              var u = e.$$typeof;
              if (u === V) {
                ((t.tag = 11), (t = od(null, t, e, n, l)));
                break e;
              } else if (u === K) {
                ((t.tag = 14), (t = cd(null, t, e, n, l)));
                break e;
              }
            }
      ...
      case 1:
        return ((n = t.type), (u = oa(n, t.pendingProps)), vd(e, t, n, u, l));
      case 3:
        e: {
          ...
          if (
            ...
            if (
              ...
              ((u = jt(Error(i(424)), t)), Tn(u), (t = gd(e, t, n, l)));
              break e;
            } else
              for (
      ...
      case 27:
        return (
          ...
          e === null &&
            Se &&
            ((n = t.stateNode = zm(t.type, t.pendingProps, ve.current)),
            (Ie = t),
            (wt = !0),
            (u = De),
      ...
      case 5:
        return (
          e === null &&
            Se &&
            ((u = n = De) &&
              ((n = mg(n, t.type, t.pendingProps, wt)),
              n !== null ?
                ((t.stateNode = n),
                (Ie = t),
                (De = Bt(n.firstChild)),
          ...
          (n = o.children),
          eo(u, o) ? (n = null) : m !== null && eo(u, m) && (t.flags |= 32),
          t.memoizedState !== null &&
            ((u = Ir(e, t, Nv, null, null, l)), (Fn._currentValue = u)),
          es(e, t),
          tt(e, t, n, l),
          t.child
        );
      case 6:
        return (
          e === null &&
            Se &&
            ((e = l = De) &&
              ((l = hg(l, t.pendingProps, wt)),
              l !== null ?
                ((t.stateNode = l), (Ie = t), (De = null), (e = !0))
              : (e = !1)),
            e || El(t)),
          null
        );
      ...
      case 24:
        return (
          ...
          e === null ?
            ...
            Zr(t),
            Cl(t, Ve, u))
          : ((e.lanes & l) !== 0 && (kr(e, t), On(t, null, null, l), zn()),
            (u = e.memoizedState),
            (o = t.memoizedState),
            u.parent !== n ?
              ((u = { parent: n, cache: n }),
  ...
  function ls(e, t) {
    (t !== null && (e.flags |= 4),
      e.flags & 16384 &&
        ((t = e.tag !== 22 ? ec() : 536870912), (e.lanes |= t), ($a |= t)));
  }
  function Bn(e, t) {
    if (!Se)
      switch (e.tailMode) {
    ...
    switch ((Lr(t), t.tag)) {
      ...
      case 26:
        ...
        return (
          e === null ?
            (rl(t),
            o !== null ? (Re(t), xd(t, o)) : (Re(t), Au(t, u, null, n, l)))
          : o ?
            o !== e.memoizedState ?
              (rl(t), Re(t), xd(t, o))
            : (Re(t), (t.flags &= -16777217))
          : ((e = e.memoizedProps), e !== n && rl(t), Re(t), Au(t, u, e, n, l)),
          null
        );
      case 27:
        if (
          ...
          ((e = le.current),
            wa(t) ? ef(t) : ((e = zm(u, n, l)), (t.stateNode = e), rl(t)));
        }
        return (Re(t), null);
      case 5:
        ...
        return (
          Re(t),
          Au(t, t.type, e === null ? null : e.memoizedProps, t.pendingProps, l),
          null
        );
      case 6:
        if (e && t.stateNode != null) e.memoizedProps !== n && rl(t);
          ...
          if (((e = ve.current), wa(t))) {
            ...
            ((e = gs(e).createTextNode(n)), (e[We] = t), (t.stateNode = e));
        }
        return (Re(t), null);
      case 31:
  ...
  var ul = !1,
    ...
    Je = null;
  function qv(e, t) {
    if (((e = e.containerInfo), (Wu = Es), (e = qc(e)), Er(e))) {
    ...
    for (
      Iu = { focusedElem: e, selectionRange: l }, Es = !1, Je = t;
      Je !== null;
    )
      if (
  ...
  function Od(e, t, l) {
    ...
    switch (l.tag) {
      ...
      case 26:
      case 5:
        (cl(e, l), t === null && n & 4 && Md(l), n & 512 && Un(l, l.return));
        break;
      case 12:
        cl(e, l);
        break;
      ...
      case 13:
        (cl(e, l),
          ...
          n & 64 &&
            ...
            e !== null &&
              ((e = e.dehydrated),
              e !== null && ((l = Jv.bind(null, l)), pg(e, l)))));
        break;
      case 22:
    ...
    switch (l.tag) {
      ...
      case 1:
        (Ze ||
          (kt(l, t),
          (n = l.stateNode),
          typeof n.componentWillUnmount == 'function' && Cd(l, t, n)),
          ol(e, t, l));
        break;
      case 21:
        ol(e, t, l);
      ...
      for (var n = 0; n < l.length; n++) {
        ...
        e: for (; _ !== null; ) {
          switch (_.tag) {
            ...
            case 3:
            case 4:
              ((we = _.stateNode.containerInfo), (dt = !0));
              break e;
          }
          _ = _.return;
        }
    ...
    switch (e.tag) {
          ...
          if (((n = e.memoizedState), l === null))
            if (n === null)
              if (e.stateNode === null) {
                e: {
                  ...
                  t: switch (n) {
                    case 'title':
                      ...
                      break e;
                    case 'link':
                      var m = Lm('link', 'href', u).get(n + (l.href || ''));
                      if (m) {
                ...
                e.stateNode = n;
              } else Bm(u, e.type, e.stateNode);
            else e.stateNode = wm(u, n, e.memoizedProps);
          else
            o !== n ?
              (o === null ?
                l.stateNode !== null &&
              ...
              : o.count--,
              n === null ?
                Bm(u, e.type, e.stateNode)
              : wm(u, n, e.memoizedProps))
            : n === null &&
              e.stateNode !== null &&
      ...
      case 27:
        (mt(t, e),
          ht(e),
          n & 512 && (Ze || l === null || kt(l, l.return)),
          l !== null && n & 4 && Nu(e, e.memoizedProps, l.memoizedProps));
        break;
      case 5:
        if (
          (mt(t, e),
        ...
        (n & 4 &&
          e.stateNode != null &&
          ((u = e.memoizedProps), Nu(e, u, l !== null ? l.memoizedProps : u)),
          n & 1024 && (ju = !0));
        break;
      case 6:
        if ((mt(t, e), ht(e), n & 4)) {
    ...
    for (e = e.child; e !== null; ) {
      ...
      switch (t.tag) {
        ...
        case 1:
          kt(t, t.return);
          var l = t.stateNode;
          (typeof l.componentWillUnmount == 'function' && Cd(t, t.return, l),
            ca(t));
          break;
        case 27:
          $n(t.stateNode);
    ...
    for (l = l && (t.subtreeFlags & 8772) !== 0, t = t.child; t !== null; ) {
      ...
      switch (o.tag) {
        ...
        case 1:
          ...
          (l && m & 64 && Ed(o), Un(o, o.return));
          break;
        case 27:
          Nd(o);
        case 26:
        case 5:
          (fl(u, o, l), l && n === null && m & 4 && Md(o), Un(o, o.return));
          break;
        case 12:
          fl(u, o, l);
          break;
        case 31:
          (fl(u, o, l), l && m & 4 && Rd(u, o));
          break;
        case 13:
          (fl(u, o, l), l && m & 4 && wd(u, o));
          break;
        case 22:
  ...
  function Vt(e, t, l, n) {
    if (t.subtreeFlags & 10256)
      for (t = t.child; t !== null; ) (Hd(e, t, l, n), (t = t.sibling));
  }
  function Hd(e, t, l, n) {
    var u = t.flags;
    switch (t.tag) {
        ...
        case 22:
          ...
          (m.memoizedState !== null ?
            q._visibility & 2 ?
              Qa(o, m, _, C, u)
            : Gn(o, m)
          : ((q._visibility |= 2), Qa(o, m, _, C, u)),
            u && L & 2048 && Du(m.alternate, m));
          break;
        case 24:
          (Qa(o, m, _, C, u), u && L & 2048 && Ru(m.alternate, m));
          break;
        default:
          Qa(o, m, _, C, u);
      }
  ...
  function Za(e, t, l) {
    if (e.subtreeFlags & qn)
      for (e = e.child; e !== null; ) (Ud(e, t, l), (e = e.sibling));
  }
  function Ud(e, t, l) {
    switch (e.tag) {
      case 26:
        (Za(e, t, l),
          e.flags & qn &&
            e.memoizedState !== null &&
            Ag(l, Yt, e.memoizedState, e.memoizedProps));
        break;
      case 5:
        Za(e, t, l);
        break;
  ...
  var Vv = {
      ...
      cacheSignal: function () {
        return et(Ve).controller.signal;
      },
    },
    ...
    do {
      if (u === 0) {
        ...
        if (u === 2) {
          ...
          if (m !== 0) {
            ...
            e: {
              ...
              if ((C && (Ja(_, m).flags |= 256), (m = Yu(_, m, !1)), m !== 2)) {
                if (wu && !C) {
        ...
        e: {
          ...
          kd(n, l, pt, us, Bu, t, Ct, fa, $a, Dl, o, null, -0, 0);
        }
      }
      break;
    } while (!0);
  ...
  function kd(e, t, l, n, u, o, m, _, C, L, q, Q, B, U) {
    if (
      ((e.timeoutHandle = -1),
      (Q = t.subtreeFlags),
      ...
      var te =
        ...
        : (o & 4194048) === o ? Vd - gt()
        : 0;
      if (((te = Ng(Q, te)), te !== null)) {
        ((ml = o),
          (e.cancelPendingCommit = te(
            em.bind(null, e, t, o, l, n, u, m, _, C, q, Q, null, B, U),
          )),
          Bl(e, o, m, !L));
        return;
      }
    }
    em(e, t, o, l, n, u, m, _, C);
  }
  function Qv(e) {
    for (var t = e; ; ) {
      var l = t.tag;
  ...
  function Kd() {
    ...
    return (
      e === null ? !0
      : (_e & 4194048) === _e ? Lt === null
      : (_e & 62914560) === _e || (_e & 536870912) !== 0 ? e === Lt
      : !1
    );
  }
  function Jd() {
  ...
  function cs() {
    ((He = 4),
      Dl || ((_e & 4194048) !== _e && xt.current !== null) || (ka = !0),
        ...
        if (Me !== 0 && ge !== null) {
          ...
          switch (Me) {
            ...
            case 6:
              xt.current === null && (t = !0);
              var L = Me;
              if (((Me = 0), (Et = null), Fa(e, _, C, L), l && ka)) {
                m = 0;
                break e;
              }
              break;
            default:
              ((L = Me), (Me = 0), (Et = null), Fa(e, _, C, L));
          }
        }
        (Zv(), (m = He));
        break;
          ...
          t: switch (Me) {
            ...
            case 5:
              ...
              switch (ge.tag) {
                ...
                case 27:
                  var _ = ge;
                  if (m ? Hm(m) : _.stateNode.complete) {
                    ((Me = 0), (Et = null));
                    var C = _.sibling;
                    if (C !== null) ge = C;
                    else {
                      var L = _.return;
                      L !== null ? ((ge = L), fs(L)) : (ge = null);
                    }
                    break t;
                  }
              }
  ...
  function $v() {
    for (; ge !== null && !vp(); ) Pd(ge);
  }
  function Pd(e) {
    var t = Sd(e.alternate, e, dl);
  ...
  function Wd(e) {
    ...
    switch (t.tag) {
      case 15:
      case 0:
        t = pd(l, t, t.pendingProps, t.type, void 0, _e);
        break;
      case 11:
        t = pd(l, t, t.pendingProps, t.type.render, t.ref, _e);
        break;
      case 5:
        lu(t);
      default:
        (Td(l, t), (t = ge = Jc(t, dl)), (t = Sd(l, t, dl)));
    }
    ((e.memoizedProps = e.pendingProps), t === null ? fs(e) : (ge = t));
  }
  function Fa(e, t, l, n) {
      ...
      if ((t.subtreeFlags & 13878) !== 0 || l) {
        ...
        try {
          ...
          if (
            ...
            _ &&
            _.ownerDocument &&
            Gc(_.ownerDocument.documentElement, _)
          ) {
            if (C !== null && Er(_)) {
              var L = C.start,
                q = C.end;
              if ((q === void 0 && (q = L), 'selectionStart' in _))
                ((_.selectionStart = L),
                ...
                if (B.getSelection) {
                  var U = B.getSelection(),
                    ...
                    se = Math.min(C.start, te),
                    Oe = C.end === void 0 ? se : Math.min(C.end, te);
                  ...
                  if (
                    ...
                    (w.setStart(R.node, R.offset),
                      U.removeAllRanges(),
                      se > Oe ?
                        (U.addRange(w), U.extend(O.node, O.offset))
                      : (w.setEnd(O.node, O.offset), U.addRange(w)));
                  }
                }
              }
            }
  ...
  function am() {
    if (ke === 4 || ke === 3) {
      ...
      (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0 ?
        (ke = 5)
      : ((ke = 0), (Ka = Ll = null), nm(e, e.pendingLanes));
  ...
  function im() {
    ...
    try {
      ...
      var o = Ll,
        m = ml;
      if (((ke = 0), (Ka = Ll = null), (ml = 0), (Ee & 6) !== 0))
        throw Error(i(331));
      var _ = Ee;
      if (
        ((Ee |= 4),
  ...
  function Vu(e, t, l) {
    ...
    u.has(l) ||
      ((wu = !0), u.add(l), (e = Kv.bind(null, e, t, l)), t.then(e, e));
  }
  function Kv(e, t, l) {
    var n = e.pingCache;
    (n !== null && n.delete(t),
  ...
  function rm(e, t) {
    (t === 0 && (t = ec()), (e = Il(e, t)), e !== null && (cn(e, t), $t(e)));
  }
  function Jv(e) {
    var t = e.memoizedState,
      l = 0;
  ...
  function eg(e, t, l, n, u) {
    if (t === 'submit' && l && l.stateNode === u) {
      var o = dm((u[ct] || null).action),
        m = n.submitter;
      m &&
        ((t =
          (t = m[ct] || null) ?
        ...
        listeners: [
          {
            ...
            listener: function () {
              if (n.defaultPrevented) {
                if (Hl !== 0) {
                  var C = m ? mm(u, m) : new FormData(u);
                  fu(
                    l,
                    { pending: !0, data: C, method: u.method, action: o },
                    null,
                    C,
                  );
                }
  ...
  for (var ku = 0; ku < Nr.length; ku++) {
    var $u = Nr[ku],
      tg = $u.toLowerCase(),
      lg = $u[0].toUpperCase() + $u.slice(1);
    qt(tg, 'on' + lg);
  }
  (qt(Xc, 'onAnimationEnd'),
    qt(Qc, 'onAnimationIteration'),
    qt(Zc, 'onAnimationStart'),
    qt('dblclick', 'onDoubleClick'),
    qt('focusin', 'onFocus'),
    qt('focusout', 'onBlur'),
    qt(yv, 'onTransitionRun'),
    qt(_v, 'onTransitionStart'),
    qt(bv, 'onTransitionCancel'),
    qt(kc, 'onTransitionEnd'),
        ...
        if (t)
          for (var m = n.length - 1; 0 <= m; m--) {
            var _ = n[m],
              C = _.instance,
              L = _.currentTarget;
            if (((_ = _.listener), C !== o && u.isPropagationStopped()))
              break e;
            ((o = _), (u.currentTarget = L));
            try {
              o(u);
            } catch (q) {
              zi(q);
            }
            ((u.currentTarget = null), (o = C));
          }
        else
    ...
    if (!e[ps]) {
      ((e[ps] = !0),
        rc.forEach(function (l) {
          l !== 'selectionchange' && (ag.has(l) || Ku(l, !1, e), Ku(l, !0, e));
        }));
        ...
        if (m === 3 || m === 4) {
          ...
          if (m === 4)
            for (m = n.return; m !== null; ) {
              var C = m.tag;
              if ((C === 3 || C === 4) && m.stateNode.containerInfo === u)
                return;
              m = m.return;
            }
          for (; _ !== null; ) {
            if (((m = _a(_)), m === null)) return;
            if (((C = m.tag), C === 5 || C === 6 || C === 26 || C === 27)) {
              n = o = m;
              continue e;
            }
            _ = _.parentNode;
    ...
    _c(function () {
          ...
          for (var O = L, w; O !== null; ) {
            ...
            if (
              ...
              (Y !== 5 && Y !== 26 && Y !== 27) ||
                w === null ||
                R === null ||
                ((Y = mn(O, R)), Y != null && se.push(kn(O, Y, w))),
              Oe)
            )
              break;
            O = O.return;
      ...
      if ((t & 7) === 0) {
        e: {
          ...
          if (
            ...
            if (
              ...
              (Oe = U == null ? B : dn(U)),
              (w = te == null ? B : dn(te)),
              (B = new se(Y, O + 'leave', U, l, q)),
              (B.target = Oe),
              (B.relatedTarget = w),
              (Y = null),
              _a(q) === L &&
                ((se = new se(R, O + 'enter', te, l, q)),
                (se.target = w),
                (se.relatedTarget = Oe),
                (Y = se)),
              (Oe = Y),
              ...
              t: {
                for (se = ng, R = U, O = te, w = 0, Y = R; Y; Y = se(Y)) w++;
                Y = 0;
                for (var ie = O; ie; ie = se(ie)) Y++;
                for (; 0 < w - Y; ) ((R = se(R)), w--);
                for (; 0 < Y - w; ) ((O = se(O)), Y--);
                for (; w--; ) {
            ...
            (U !== null && vm(Q, B, U, se, !1),
              te !== null && Oe !== null && vm(Q, Oe, te, se, !0));
          }
        }
        e: {
          if (
        ...
        if (Sr)
          ...
          Aa ?
            Nc(e, l) && (be = 'onCompositionEnd')
          : e === 'keydown' && l.keyCode === 229 && (be = 'onCompositionStart');
        (be &&
          (Cc &&
            l.locale !== 'ko' &&
            (Aa || be !== 'onCompositionStart' ?
              be === 'onCompositionEnd' && Aa && (he = bc())
            : ((Sl = q),
              (vr = 'value' in Sl ? Sl.value : Sl.textContent),
              (Aa = !0))),
          (ae = vs(L, be)),
          0 < ae.length &&
            ((be = new Tc(be, e, null, l, q)),
            Q.push({ event: be, listeners: ae }),
            he ?
              (be.data = he)
            : ((he = zc(l)), he !== null && (be.data = he)))),
          (he = rv ? uv(e, l) : ov(e, l)) &&
            ((be = vs(L, 'onBeforeInput')),
            0 < be.length &&
              ((ae = new Tc('onBeforeInput', 'beforeinput', null, l, q)),
  ...
  function vm(e, t, l, n, u) {
    for (var o = t._reactName, m = []; l !== null && l !== n; ) {
      var _ = l,
        C = _.alternate,
        L = _.stateNode;
      if (((_ = _.tag), C !== null && C === n)) break;
      ((_ !== 5 && _ !== 26 && _ !== 27) ||
        L === null ||
        ((C = L),
        u ?
          ((L = mn(l, o)), L != null && m.unshift(kn(l, L, C)))
        : u || ((L = mn(l, o)), L != null && m.push(kn(l, L, C)))),
        (l = l.return));
    }
...
`,
    ...
    switch (l) {
      ...
      default:
        (!(2 < l.length) ||
          (l[0] !== 'o' && l[0] !== 'O') ||
          (l[1] !== 'n' && l[1] !== 'N')) &&
          ((l = wp.get(l) || l), _i(e, l, n));
    }
  }
  function Pu(e, t, l, n, u, o) {
    switch (l) {
      case 'style':
        gc(e, n, o);
        break;
    ...
    switch (t) {
      ...
      default:
        if (fr(t)) {
          for (q in l)
            l.hasOwnProperty(q) &&
              ((n = l[q]), n !== void 0 && Pu(e, t, q, n, l, void 0));
          return;
        }
    }
    for (_ in l)
      l.hasOwnProperty(_) && ((n = l[_]), n != null && ze(e, t, _, n, l, null));
  }
  function rg(e, t, l, n) {
    switch (t) {
      case 'div':
          ...
          if (l.hasOwnProperty(U) && Q != null)
            switch (U) {
              ...
              case 'defaultValue':
                C = Q;
              default:
                n.hasOwnProperty(U) || ze(e, t, U, null, n, Q);
            }
        }
        for (var B in n) {
          var U = n[B];
      ...
      case 'select':
        U = m = _ = B = null;
        for (o in l)
          if (((C = l[o]), l.hasOwnProperty(o) && C != null))
            switch (o) {
              case 'value':
                break;
              case 'multiple':
                U = C;
              default:
                n.hasOwnProperty(o) || ze(e, t, o, null, n, C);
            }
        for (u in n)
          if (
            ((o = n[u]),
            (C = l[u]),
            n.hasOwnProperty(u) && (o != null || C != null))
          )
            switch (u) {
              case 'value':
                B = o;
      ...
      for (
        ...
        if (o && _ && _m(m)) {
          for (m = 0, _ = u.responseEnd, n += 1; n < l.length; n++) {
            ...
            q &&
              _m(Q) &&
              ((C = C.responseEnd), (m += q * (C < _ ? 1 : (_ - L) / (C - L))));
          }
  ...
  var xm = typeof setTimeout == 'function' ? setTimeout : void 0,
    ...
    fg =
      ...
      : typeof Tm < 'u' ?
        function (e) {
          return Tm.resolve(null).then(e).catch(dg);
        }
      : xm;
  function dg(e) {
    setTimeout(function () {
  ...
  var hl = Z.d;
  Z.d = { f: vg, r: gg, D: yg, C: _g, L: bg, m: Sg, X: Tg, S: xg, M: Eg };
  function vg() {
    var e = hl.f(),
      t = os();
    return e || t;
  ...
  function gg(e) {
    var t = ba(e);
    t !== null && t.tag === 5 && t.type === 'form' ? $f(t) : hl.r(e);
  }
  ...
  function yg(e) {
    (hl.D(e), jm('dns-prefetch', e, null));
  }
  function _g(e, t) {
    (hl.C(e, t), jm('preconnect', e, t));
  }
  function bg(e, t, l) {
    hl.L(e, t, l);
    var n = Wa;
      ...
      if (!m) {
        ...
        if ((m = n.querySelector(Kn(o)))) _.loading = 5;
          ...
          ((e = y({ 'rel': 'stylesheet', 'href': e, 'data-precedence': t }, l)),
            (l = Ht.get(o)) && so(e, l));
          var C = (m = n.createElement('link'));
          (Ke(C),
            lt(C, 'link', e),
            (C._p = new Promise(function (L, q) {
              ((C.onload = L), (C.onerror = q));
            })),
  ...
  function wm(e, t, l) {
    if ((t.count++, t.instance === null))
      switch (t.type) {
        case 'style':
          var n = e.querySelector('style[data-href~="' + zt(l.href) + '"]');
        ...
        case 'stylesheet':
          ...
          var m = o;
          return (
            (m._p = new Promise(function (_, C) {
              ((m.onload = _), (m.onerror = C));
            })),
            lt(o, 'link', n),
            (t.state.loading |= 4),
            _s(o, l.precedence, e),
  ...
  function Um(e, t, l, n, u, o, m, _, C, L, q, Q) {
    return (
      (e = new Og(e, t, l, m, C, L, q, Q, _)),
      (t = 1),
      o === !0 && (t |= 24),
      (o = St(3, null, null, t)),
      (e.current = o),
  ...
  function co(e, t, l, n) {
    if (Es) {
      var u = fo(n);
      if (u === null) (Fu(e, t, n, Cs, l), Zm(e, n));
      else if (wg(u, e, t, l, n)) n.stopPropagation();
      else if ((Zm(e, n), t & 4 && -1 < Rg.indexOf(e))) {
        for (; u !== null; ) {
          var o = ba(u);
          if (o !== null)
            switch (o.tag) {
                ...
                if (((o = o.stateNode), o.current.memoizedState.isDehydrated)) {
                  ...
                  if (m !== 0) {
                    ...
                    for (_.pendingLanes |= 2, _.entangledLanes |= 2; m; ) {
                      var C = 1 << (31 - _t(m));
                      ((_.entanglements[1] |= C), (m &= ~C));
                    }
                    ($t(o), (Ee & 6) === 0 && ((rs = gt() + 500), Qn(0)));
                  }
                }
                break;
              case 31:
              case 13:
                ((_ = Il(o, 2)), _ !== null && vt(_, o, 2), os(), oo(o, 2));
            }
          if (((o = fo(n)), o === null && Fu(e, t, n, Cs, l), o === u)) break;
          u = o;
        }
  ...
  function Ms(e) {
    ...
    for (var t = e.targetContainers; 0 < t.length; ) {
      ...
      } else return ((t = ba(l)), t !== null && Vm(t), (e.blockedOn = l), !1);
      t.shift();
    }
    return !0;
  }
  ...
  function As(e, t) {
    e.blockedOn === t &&
      ...
      ho ||
        ((ho = !0),
        a.unstable_scheduleCallback(a.unstable_NormalPriority, Lg)));
  }
  var Ns = null;
  function Km(e) {
    Ns !== e &&
  ...
  function tn(e) {
    ...
    for (; 0 < Vl.length && ((l = Vl[0]), l.blockedOn === null); )
      (km(l), l.blockedOn === null && Vl.shift());
    if (((l = (e.ownerDocument || e).$$reactFormReplay), l != null))
      for (n = 0; n < l.length; n += 3) {
        var u = l[n],
          o = l[n + 1],
          m = u[ct] || null;
        if (typeof o == 'function') m || Km(l);
        else if (m) {
          var _ = null;
  ...
  ((zs.prototype.render = po.prototype.render =
    function (e) {
    ...
    (zs.prototype.unmount = po.prototype.unmount =
      function () {
        var e = this._internalRoot;
        if (e !== null) {
          this._internalRoot = null;
          var t = e.containerInfo;
          (qm(e.current, 2, null, e, null, null), os(), (t[ya] = null));
        }
      }));
  function zs(e) {
    this._internalRoot = e;
  ...
  zs.prototype.unstable_scheduleHydration = function (e) {
    if (e) {
      ...
      (Vl.splice(l, 0, e), l === 0 && km(e));
    }
  };
  var Fm = r.version;
  if (Fm !== '19.2.4') throw Error(i(527, Fm, '19.2.4'));
  ...
  return (
    (ti.createRoot = function (e, t) {
      ...
      return (
        ...
        (t = Um(e, 1, !1, null, null, l, n, null, u, o, m, Jm)),
        (e[ya] = t.current),
        Ju(e),
        new po(t)
      );
    ...
    (ti.hydrateRoot = function (e, t, l) {
      ...
      return (
        ...
        (t = Um(e, 1, !0, t, l ?? null, n, u, C, o, m, _, Jm)),
        (t.context = Gm(null)),
        (l = t.current),
        (n = Mt()),
        (n = nr(n)),
...
function kg() {
  ...
  return (a(), (go.exports = Zg()), go.exports);
}
var $g = kg(),
  N = Uo();
const $e = xh(N);
...
function Fg(a, r, s, i = {}) {
  ...
  function y() {
    ...
    let M = b(),
      x = M == null ? null : M - p;
    ((p = M), d && d({ action: g, location: T.location, delta: x }));
  }
  function A(M, x) {
    g = 'PUSH';
    let E = Ro(T.location, M, x);
    (s && s(E, M), (p = b() + 1));
    let D = uh(E, p),
      V = T.createHref(E);
    try {
    ...
    f && d && d({ action: g, location: T.location, delta: 1 });
  }
  function S(M, x) {
    g = 'REPLACE';
    let E = Ro(T.location, M, x);
    ...
    let D = uh(E, p),
      V = T.createHref(E);
    (h.replaceState(D, '', V),
      f && d && d({ action: g, location: T.location, delta: 0 }));
  }
  function j(M) {
    return Pg(M);
  }
  let T = {
    ...
    listen(M) {
      ...
      return (
        c.addEventListener(rh, y),
        (d = M),
        () => {
          (c.removeEventListener(rh, y), (d = null));
        }
      );
    },
    createHref(M) {
...
function Wg(a, r, s, i) {
  ...
  Ig(h);
  let g = null;
  for (let d = 0; g == null && d < h.length; ++d) {
    let p = c0(f);
    g = u0(h[d], p, i);
  }
  return g;
}
function Eh(a, r = [], s = [], i = '', c = !1) {
  let f = (h, g, d = c, p) => {
    let b = {
    ...
    (h.children &&
      ...
      Eh(h.children, r, A, y, d)),
      !(h.path == null && !h.index) &&
        r.push({ path: y, score: s0(y, h.index), routesMeta: A }));
  };
  return (
    a.forEach((h, g) => {
      if (h.path === '' || !h.path?.includes('?')) f(h, g);
      else for (let d of Ch(h.path)) f(h, g, !0, d);
    }),
    r
  );
}
...
function u0(a, r, s = !1) {
  ...
  for (let g = 0; g < i.length; ++g) {
    ...
    (Object.assign(c, y.params),
      h.push({
        params: c,
        pathname: gl([f, y.pathname]),
        pathnameBase: h0(gl([f, y.pathnameBase])),
        route: A,
      }),
      y.pathnameBase !== '/' && (f = gl([f, y.pathnameBase])));
  }
  return h;
}
function Gs(a, r) {
  typeof a == 'string' && (a = { path: a, caseSensitive: !1, end: !0 });
  let [s, i] = o0(a.path, a.caseSensitive, a.end),
    c = r.match(s);
  if (!c) return null;
  let f = c[0],
    h = f.replace(/(.)\/+$/, '$1'),
    g = c.slice(1);
  return {
    params: i.reduce((p, { paramName: b, isOptional: y }, A) => {
      if (b === '*') {
        let j = g[A] || '';
      ...
      const S = g[A];
      return (
        y && !S ? (p[b] = void 0) : (p[b] = (S || '').replace(/%2F/g, '/')),
        p
      );
    }, {}),
    pathname: f,
...
function d0(a, r = '/') {
  ...
  return (
    s ?
      ((s = s.replace(/\/\/+/g, '/')),
      s.startsWith('/') ? (f = ch(s.substring(1), '/')) : (f = ch(s, r)))
    : (f = r),
    { pathname: f, search: p0(i), hash: v0(c) }
  );
}
function ch(a, r) {
...
var S0 = N.createContext(!1),
  jh = N.createContext({ isTransitioning: !1 });
jh.displayName = 'ViewTransition';
var x0 = N.createContext(new Map());
x0.displayName = 'Fetchers';
var T0 = N.createContext(null);
...
var Go = N.createContext(null);
Go.displayName = 'RouteError';
var Dh = 'REACT_ROUTER_ERROR',
  E0 = 'REDIRECT',
  C0 = 'ROUTE_ERROR_RESPONSE';
function M0(a) {
  if (a.startsWith(`${Dh}:${E0}:{`))
    try {
  ...
  if (a.startsWith(`${Dh}:${C0}:{`))
    try {
      ...
      if (
        ...
        return new g0(r.status, r.statusText, r.data);
    } catch {}
}
function N0(a, { relative: r } = {}) {
  Le(
    ci(),
  ...
  return (
    s !== '/' && (g = f === '/' ? s : gl([s, f])),
    i.createHref({ pathname: g, search: h, hash: c })
  );
}
function ci() {
...
function z0() {
  ...
  return (
    ...
    N.useCallback(
      (d, p = {}) => {
        if ((Xt(h.current, Rh), !h.current)) return;
        if (typeof d == 'number') {
          s.go(d);
          return;
        }
        let b = Ah(d, JSON.parse(f), c, p.relative === 'path');
        (a == null &&
          r !== '/' &&
...
function fi(a, { relative: r } = {}) {
  let { matches: s } = N.useContext(Ft),
    { pathname: i } = kl(),
    c = JSON.stringify(Mh(s));
  return N.useMemo(() => Ah(a, JSON.parse(c), i, r === 'path'), [a, c, i, r]);
}
function O0(a, r) {
  return Bh(a, r);
}
function Bh(a, r, s, i, c) {
  Le(
    ci(),
...
Please change the parent <Route path="${E}"> to <Route path="${E === '/' ? '*' : `${E}/*`}">.`,
  ...
  if (r) {
    ...
    (Le(
      b === '/' || E.pathname?.startsWith(b),
      `When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${b}" but pathname "${E.pathname}" was given in the \`location\` prop.`,
    ),
      (S = E));
  } else S = A;
  let j = S.pathname || '/',
    T = j;
  if (b !== '/') {
    let E = b.replace(/^\//, '').split('/');
    T = '/' + j.replace(/^\//, '').split('/').slice(E.length).join('/');
  }
  let M = Th(a, { pathname: T });
  (Xt(
    y || M != null,
...
var D0 = N.createElement(j0, null),
  Hh = class extends N.Component {
    constructor(a) {
      (super(a),
        (this.state = {
          location: a.location,
    ...
    render() {
      ...
      let r =
        ...
        : this.props.children;
      return this.context ? N.createElement(R0, { error: a }, r) : r;
    }
  };
Hh.contextType = S0;
var To = new WeakMap();
function R0({ children: a, error: r }) {
...
function w0({ routeContext: a, match: r, children: s }) {
...
function L0(a, r = [], s = null, i = null, c = null) {
  if (a == null) {
    if (!s) return null;
  ...
  let f = a,
    h = s?.errors;
  if (h != null) {
    let b = f.findIndex((y) => y.route.id && h?.[y.route.id] !== void 0);
    (Le(
      b >= 0,
  ...
  if (s)
    for (let b = 0; b < f.length; b++) {
      let y = f[b];
      if (
        ((y.route.HydrateFallback || y.route.hydrateFallbackElement) && (d = b),
        y.route.id)
      ) {
        let { loaderData: A, errors: S } = s,
          j =
            y.route.loader &&
            !A.hasOwnProperty(y.route.id) &&
    ...
    s && i ?
      (b, y) => {
        i(b, {
          ...
          unstable_pattern: _0(s.matches),
          errorInfo: y,
        });
      }
    : void 0;
  return f.reduceRight((b, y, A) => {
    let S,
      j = !1,
      T = null,
      M = null;
    s &&
      ((S = h && y.route.id ? h[y.route.id] : void 0),
      (T = y.route.errorElement || D0),
      g &&
        (d < 0 && A === 0 ?
          (Uh(
            'route-fallback',
          ...
          (j = !0),
          (M = null))
        : d === A && ((j = !0), (M = y.route.hydrateFallbackElement || null))));
    let x = r.concat(f.slice(0, A + 1)),
      E = () => {
        let D;
        return (
          S ? (D = T)
          : j ? (D = M)
          : y.route.Component ? (D = N.createElement(y.route.Component, null))
          : y.route.element ? (D = y.route.element)
          : (D = b),
          N.createElement(w0, {
            match: y,
    ...
    return s && (y.route.ErrorBoundary || y.route.errorElement || A === 0) ?
        N.createElement(Hh, {
          location: s.location,
...
function G0() {
  return Vo('useRouteId');
}
function q0() {
  let a = N.useContext(Go),
    r = H0('useRouteError'),
    s = Vo('useRouteError');
  return a !== void 0 ? a : r.errors?.[s];
}
function Y0() {
  let { router: a } = B0('useNavigate'),
    r = Vo('useNavigate'),
    s = N.useRef(!1);
  return (
    wh(() => {
...
var fh = {};
function Uh(a, r, s) {
  !r && !fh[a] && ((fh[a] = !0), Xt(!1, s));
}
N.memo(V0);
function V0({ routes: a, future: r, state: s, onError: i }) {
  return Bh(a, void 0, s, i, r);
}
function pl(a) {
  Le(
    !1,
...
function X0({
  ...
  let {
    ...
    j = N.useMemo(() => {
      ...
      return T == null ? null : (
          {
            location: { pathname: T, search: b, hash: y, state: A, key: S },
            navigationType: i,
          }
        );
    }, [g, p, b, y, A, S, i]);
  return (
    Xt(
      j != null,
      `<Router basename="${g}"> is not able to match the URL "${p}${b}${y}" because it does not start with the basename, so the <Router> won't render anything.`,
    ),
    j == null ? null : (
      N.createElement(
        Gt.Provider,
  ...
  return (
    N.Children.forEach(a, (i, c) => {
      ...
      if (i.type === N.Fragment) {
        s.push.apply(s, wo(i.props.children, f));
        return;
      }
      (Le(
        i.type === pl,
      ...
      (i.props.children && (h.children = wo(i.props.children, f)), s.push(h));
    }),
    s
  );
}
...
function J0(a, r) {
  return a.button === 0 && (!r || r === '_self') && !K0(a);
}
var js = null;
function F0() {
  if (js === null)
...
function W0(a, r) {
  ...
  if (k0(a)) {
    ...
    ((i = g ? yl(g, r) : null),
      ...
      (c = Eo(a.getAttribute('enctype')) || Bs),
      (f = new FormData(a)));
  } else if (Z0(a) || ($0(a) && (a.type === 'submit' || a.type === 'image'))) {
    let g = a.form;
    if (g == null)
      throw new Error(
    ...
    if (
      ...
      (c =
        ...
        Eo(g.getAttribute('enctype')) ||
        Bs),
      (f = new FormData(g, a)),
      !F0())
    ) {
      let { name: p, type: b, value: y } = a;
      if (b === 'image') {
        let A = p ? `${p}.` : '';
...
function ay(a, r, { includeHydrateFallback: s } = {}) {
  return ny(
    a
      .map((i) => {
...
var Qo = N.createContext(void 0);
Qo.displayName = 'FrameworkContext';
function qh() {
  let a = N.useContext(Qo);
  return (
    Xo(a, 'You must render this element inside a <HydratedRouter> element'),
    a
  );
}
function uy(a, r) {
  let s = N.useContext(Qo),
    [i, c] = N.useState(!1),
    [f, h] = N.useState(!1),
    {
      onFocus: g,
...
function oy({ page: a, ...r }) {
  let { router: s } = Gh(),
    i = N.useMemo(() => Th(s.routes, a, s.basename), [s.routes, a, s.basename]);
  return i ? N.createElement(fy, { page: a, matches: i, ...r }) : null;
}
function cy(a) {
  let { manifest: r, routeModules: s } = qh(),
    [i, c] = N.useState([]);
  return (
    N.useEffect(() => {
      let f = !1;
...
function fy({ page: a, matches: r, ...s }) {
  let i = kl(),
    { future: c, manifest: f, routeModules: h } = qh(),
    { basename: g } = Gh(),
    { loaderData: d, matches: p } = ry(),
    b = N.useMemo(() => dh(a, r, p, f, i, 'data'), [a, r, p, f, i]),
    y = N.useMemo(() => dh(a, r, p, f, i, 'assets'), [a, r, p, f, i]),
    A = N.useMemo(() => {
      ...
      if (
        (r.forEach((E) => {
          let D = f.routes[E.route.id];
          !D ||
            !D.hasLoader ||
            ((
              (!b.some((V) => V.route.id === E.route.id) &&
                E.route.id in d &&
                h[E.route.id]?.shouldRevalidate) ||
              D.hasClientLoader
            ) ?
              (M = !0)
            : T.add(E.route.id));
        ...
        return [];
      let x = I0(a, g, c.unstable_trailingSlashAwareDataRequests, 'data');
      return (
        M &&
          T.size > 0 &&
          x.searchParams.set(
    ...
    }, [g, c.unstable_trailingSlashAwareDataRequests, d, i, f, b, r, a, h]),
    S = N.useMemo(() => ay(y, f), [y, f]),
    j = cy(y);
  return N.createElement(
    ...
    S.map((T) =>
      N.createElement('link', { key: T, rel: 'modulepreload', href: T, ...s }),
    ),
    j.map(({ key: T, link: M }) =>
      N.createElement('link', {
        key: T,
...
function hy({
  ...
  let c = N.useRef();
  c.current == null && (c.current = Kg({ window: i, v5Compat: !0 }));
  let f = c.current,
    [h, g] = N.useState({ action: f.action, location: f.location }),
    d = N.useCallback(
      (p) => {
...
var Yh = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Zl = N.forwardRef(function (
    ...
    let { basename: T, unstable_useTransitions: M } = N.useContext(Gt),
      x = typeof p == 'string' && Yh.test(p),
      E = zh(p, T);
    p = E.to;
    let D = N0(p, { relative: c }),
      [V, $, I] = uy(i, S),
      K = gy(p, {
        replace: h,
        state: g,
    ...
    return V && !x ?
        N.createElement(N.Fragment, null, ne, N.createElement(oy, { page: D }))
      : ne;
  });
Zl.displayName = 'Link';
var ha = N.forwardRef(function (
  ...
  let y = fi(h, { relative: p.relative }),
    A = kl(),
    S = N.useContext(Zs),
    { navigator: j, basename: T } = N.useContext(Gt),
    M = S != null && xy(y) && g === !0,
    x = j.encodeLocation ? j.encodeLocation(y).pathname : y.pathname,
    E = A.pathname,
    D =
  ...
  let $ = E === x || (!c && E.startsWith(x) && E.charAt(V) === '/'),
    I =
      D != null &&
      (D === x || (!c && D.startsWith(x) && D.charAt(x.length) === '/')),
    K = { isActive: $, isPending: I, isTransitioning: M },
    H = $ ? r : void 0,
    ne;
  typeof i == 'function' ?
    (ne = i(K))
...
var py = N.forwardRef(
  (
    ...
    let { unstable_useTransitions: T } = N.useContext(Gt),
      M = by(),
      x = Sy(g, { relative: p }),
      E = h.toLowerCase() === 'get' ? 'get' : 'post',
      D = typeof g == 'string' && Yh.test(g),
      V = ($) => {
...
function gy(
  ...
  return N.useCallback(
    ...
    [b, p, y, s, i, r, a, c, f, h, g, d],
  );
}
var yy = 0,
  _y = () => `__${String(++yy)}__`;
function by() {
  let { router: a } = Vh('useSubmit'),
  ...
  return N.useCallback(
    async (f, h = {}) => {
      let { action: g, method: d, encType: p, formData: b, body: y } = W0(f, r);
      if (h.navigate === !1) {
        let A = h.fetcherKey || _y();
        await i(A, s, h.action || g, {
...
function Sy(a, { relative: r } = {}) {
  ...
  if (a == null) {
    ...
    if (d.some((b) => b === '')) {
      (g.delete('index'),
        d.filter((y) => y).forEach((y) => g.append('index', y)));
      let b = g.toString();
      f.search = b ? `?${b}` : '';
    }
  }
...
function xy(a, { relative: r } = {}) {
  let s = N.useContext(jh);
  Le(
    s != null,
    "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?",
  );
  let { basename: i } = Vh('useViewTransitionState'),
    c = fi(a, { relative: r });
  ...
  return Gs(c.pathname, h) != null || Gs(c.pathname, f) != null;
}
const Ty = '_menu_fvuuk_1',
  Ey = '_menu__nav_fvuuk_17',
  Cy = '_menu__list_fvuuk_24',
  My = '_menu__link_fvuuk_33',
  Ay = '_menu__footer_fvuuk_59',
  Ny = '_footer_btn_fvuuk_66',
  ut = {
    'menu': Ty,
          ...
          children: [
            v.jsx(ha, {
              ...
              className: ({ isActive: s }) =>
                ...
                : ut.footer_btn,
              onClick: r,
              children: v.jsx('img', { src: Xh, alt: 'Favorites' }),
            }),
            v.jsx(ha, {
              to: '/cart',
              className: ({ isActive: s }) =>
                ...
                : ut.footer_btn,
              onClick: r,
              children: v.jsx('img', { src: Qh, alt: 'Cart' }),
            }),
          ],
        }),
      ],
  ...
  jy = '_header_d2bu9_1',
  Dy = '_header__container_d2bu9_16',
  Ry = '_header__left_d2bu9_23',
  wy = '_header__right_d2bu9_23',
  Ly = '_header__logo_d2bu9_27',
  By = '_header__nav_d2bu9_49',
  Hy = '_header__icons_d2bu9_64',
  Uy = '_header__burger_d2bu9_72',
  Gy = '_nav_list_d2bu9_92',
  qy = '_nav_list__item_d2bu9_109',
  Yy = '_nav_list__link_d2bu9_113',
  Vy = '_icon_btn_d2bu9_141',
  Xy = '_burger_icon_d2bu9_177',
  Ye = {
    'header': jy,
    'header__container': Dy,
    'header__left': Ry,
    'header__right': wy,
    'header__logo': Ly,
    'header__nav': By,
    ...
    'nav_list__item': qy,
    'nav_list__link': Yy,
    'nav_list__link--active': '_nav_list__link--active_d2bu9_128',
    'icon_btn': Vy,
    'icon_btn--active': '_icon_btn--active_d2bu9_160',
    'burger_icon': Xy,
    'burger_icon--active': '_burger_icon--active_d2bu9_194',
  },
  ...
  ky = () => {
    ...
    return v.jsxs(v.Fragment, {
      children: [
        ...
        v.jsx(Oy, { isOpen: a, onClose: () => r(!1) }),
      ],
    });
  },
  $y = '_footer_1p3ra_2',
  Ky = '_container_1p3ra_19',
  Jy = '_logo_1p3ra_25',
  Fy = '_nav_1p3ra_29',
  Py = '_back_1p3ra_47',
  Wy = '_arrow_1p3ra_57',
  Iy = '_logoLink_1p3ra_96',
  da = {
    footer: $y,
    container: Ky,
    logo: Jy,
  ...
  l1 = () => fetch('/api/products.json').then((a) => a.json()),
  a1 = async (a, r) => {
  ...
  kh = ({ onAddToCart: a, onToggleFavorite: r, isFavorite: s, isInCart: i }) =>
    v.jsxs('div', {
  ...
  pa = ({ product: a, onFavoriteChange: r }) => {
    ...
    if (!a) return null;
    const g = a.priceDiscount ?? ('price' in a ? a.price : void 0),
      d = a.priceRegular ?? ('fullPrice' in a ? a.fullPrice : void 0),
      p = 'images' in a ? a.images[0] : a.image,
      b = p ? `/${p}` : null,
      y = 'itemId' in a ? a.itemId : a.id,
      A = String(y).toLowerCase();
    let S = 'phones';
    A.includes('ipad') ? (S = 'tablets')
    : A.includes('watch') ? (S = 'accessories')
    : 'category' in a && a.category && (S = a.category);
    const j = `/${S}/${y}`,
      T = () => {
        const M = JSON.parse(localStorage.getItem('favorites') || '[]');
        let x;
        (M.includes(String(a.id)) ?
          (x = M.filter((E) => E !== String(a.id)))
        : (x = [...M, String(a.id)]),
    ...
    return v.jsx('div', {
      ...
      children: v.jsxs('div', {
        ...
        children: [
          ...
          v.jsx(n1, { currentPrice: g, fullPrice: d }),
          v.jsx(Zh, { screen: a.screen, capacity: a.capacity, ram: a.ram }),
          v.jsx(kh, {
            onAddToCart: (M) => {
  ...
  i1 = '_search_1flgh_19',
  s1 = '_title_1flgh_34',
  r1 = '_modelsCount_1flgh_44',
  u1 = '_controls_1flgh_52',
  o1 = '_controlsLeft_1flgh_59',
  c1 = '_control_1flgh_52',
  f1 = '_label_1flgh_69',
  d1 = '_select_1flgh_73',
  m1 = '_searchInput_1flgh_94',
  Fe = {
  ...
  h1 = '_breadcrumbs_mu3xr_1',
  p1 = '_breadcrumbs__home_mu3xr_7',
  v1 = '_breadcrumbs__separator_mu3xr_16',
  g1 = '_breadcrumbs__link_mu3xr_20',
  y1 = '_breadcrumbs__current_mu3xr_31',
  ma = {
    breadcrumbs: h1,
    breadcrumbs__home: p1,
    breadcrumbs__separator: v1,
    breadcrumbs__link: g1,
    breadcrumbs__current: y1,
  },
  nn = () => {
    const a = kl(),
      { productId: r } = qo(),
    ...
    return v.jsxs('nav', {
      ...
      children: [
        ...
        v.jsx('span', { className: ma.breadcrumbs__separator, children: '>' }),
        r ?
          v.jsx(Zl, {
            to: `/${i}`,
        ...
        : v.jsx('span', { className: ma.breadcrumbs__current, children: c(i) }),
        r &&
          v.jsxs(v.Fragment, {
            children: [
              v.jsx('span', {
  ...
  Zo = () =>
    v.jsxs('div', {
      ...
      children: [
        v.jsx('div', { className: 'card-skeleton__img' }),
        v.jsx('div', { className: 'card-skeleton__title' }),
        v.jsx('div', { className: 'card-skeleton__price' }),
        v.jsxs('div', {
          className: 'card-skeleton__features',
          children: [
            v.jsx('div', { className: 'card-skeleton__features-line' }),
            v.jsx('div', { className: 'card-skeleton__features-line' }),
            v.jsx('div', { className: 'card-skeleton__features-line' }),
          ],
        }),
        v.jsxs('div', {
          ...
          children: [
            v.jsx('div', { className: 'card-skeleton__actions-btn' }),
            v.jsx('div', { className: 'card-skeleton__actions-fav' }),
          ],
        }),
      ],
    }),
  ...
  b1 = '_icon_65sxm_11',
  S1 = '_title_65sxm_18',
  x1 = '_message_65sxm_25',
  Rs = { wrapper: _1, icon: b1, title: S1, message: x1 },
  T1 =
  ...
  ko = ({ category: a = 'products' }) =>
    v.jsxs('div', {
      className: Rs.wrapper,
      children: [
        v.jsx('img', { src: T1, alt: 'No results found', className: Rs.icon }),
        v.jsxs('h2', { className: Rs.title, children: ['No ', a, ' found'] }),
        v.jsx('p', {
  ...
  E1 = () => {
    ...
    const A = N.useMemo(() => {
        ...
        return a.filter((M) => M.name.toLowerCase().includes(T));
      }, [a, b]),
      S = N.useMemo(() => {
        const T = [...A];
        switch (s) {
          case 'alphabetically':
            return T.sort((M, x) => M.name.localeCompare(x.name));
          case 'bestPrice':
            return di(T);
          default:
            return Fs(T);
    ...
    return v.jsx('div', {
      ...
      children: v.jsxs('div', {
        ...
        children: [
          v.jsx(nn, {}),
          v.jsx('h1', { className: Fe.title, children: 'Mobile phones' }),
          !h &&
            v.jsxs('p', {
          ...
          v.jsx('section', {
            ...
            children:
              h ? Array.from({ length: 8 }).map((T, M) => v.jsx(Zo, {}, M))
              : j.length > 0 ? j.map((T) => v.jsx(pa, { product: T }, T.id))
              : v.jsx(ko, { category: 'phones' }),
          }),
          v.jsx('section', { className: Fe['phones-page__pagination'] }),
        ],
      }),
    });
  },
  C1 = '_search_6oh3h_19',
  M1 = '_title_6oh3h_34',
  A1 = '_modelsCount_6oh3h_44',
  N1 = '_controls_6oh3h_52',
  z1 = '_controlsLeft_6oh3h_59',
  O1 = '_control_6oh3h_52',
  j1 = '_label_6oh3h_69',
  D1 = '_select_6oh3h_73',
  R1 = '_searchInput_6oh3h_95',
  at = {
  ...
  w1 = () => {
    ...
    (N.useEffect(() => {
      (async () => {
        ...
        try {
          const M = await Js();
          r(M.map((x) => ({ ...x, category: 'accessories' })));
        } finally {
          setTimeout(() => g(!1), 600);
        }
      })();
    ...
    const A = N.useMemo(() => {
      ...
      j = N.useMemo(() => S.slice(0, c), [S, c]);
    return v.jsx('div', {
      className: at['accessories-page'],
      children: v.jsxs('div', {
        className: at['accessories-page__container'],
        children: [
          v.jsx(nn, {}),
          v.jsx('h1', { className: at.title, children: 'Accessories' }),
          !h &&
            v.jsxs('p', {
              className: at.modelsCount,
              children: [A.length, ' models'],
            }),
          v.jsx('section', {
            className: at['accessories-page__controls'],
            children: v.jsxs('div', {
              className: at.controls,
              children: [
                v.jsxs('div', {
                  className: at.controlsLeft,
                  children: [
                    v.jsxs('div', {
          ...
          v.jsx('section', {
            className: at['accessories-page__list'],
            children:
              h ? Array.from({ length: 8 }).map((T, M) => v.jsx(Zo, {}, M))
              : j.length > 0 ? j.map((T) => v.jsx(pa, { product: T }, T.id))
              : v.jsx(ko, { category: 'accessories' }),
          }),
        ],
      }),
    });
  ...
  L1 = '_cart_1nbcg_8',
  B1 = '_title_1nbcg_27',
  H1 = '_cartContent_1nbcg_41',
  U1 = '_products_1nbcg_66',
  G1 = '_summary_1nbcg_77',
  ai = { cart: L1, title: B1, cartContent: H1, products: U1, summary: G1 },
  q1 = '_block_1xzjy_1',
  Y1 = '_price_1xzjy_7',
  V1 = '_info_1xzjy_17',
  X1 = '_button_1xzjy_24',
  Q1 = '_buttonCheck_1xzjy_33',
  ni = { block: q1, price: Y1, info: V1, button: X1, buttonCheck: Q1 },
  Z1 = ({ totalPrice: a, totalItems: r }) =>
    v.jsxs('div', {
      className: ni.block,
      children: [
        v.jsx('h2', { className: ni.price, children: a }),
        v.jsxs('p', {
          className: ni.info,
  ...
  k1 = '_item_18h8g_1',
  $1 = '_remove_18h8g_19',
  K1 = '_imageWrapper_18h8g_37',
  J1 = '_image_18h8g_37',
  F1 = '_details_18h8g_57',
  P1 = '_name_18h8g_68',
  W1 = '_controls_18h8g_76',
  I1 = '_quantity_18h8g_91',
  e_ = '_btnPlus_18h8g_102',
  t_ = '_btnMinus_18h8g_112',
  l_ = '_count_18h8g_122',
  a_ = '_price_18h8g_128',
  Ut = {
    item: k1,
  ...
  n_ = ({ product: a, onRemove: r, onIncrease: s, onDecrease: i }) =>
    v.jsxs('div', {
      className: Ut.item,
      children: [
        v.jsx('button', {
        ...
        v.jsx('div', {
          ...
          children: v.jsx('h3', { className: Ut.name, children: a.name }),
        }),
        v.jsxs('div', {
          ...
          children: [
            v.jsxs('div', {
              ...
              children: [
                ...
                v.jsx('span', { className: Ut.count, children: a.quantity }),
                v.jsx('button', {
            ...
            v.jsx('p', { className: Ut.price, children: a.priceDiscount }),
          ],
        }),
      ],
    }),
        ...
        v.jsxs('div', {
          ...
          children: [
            v.jsxs('div', {
              ...
              children: [
                a.length === 0 &&
                  v.jsx('p', { children: 'Your cart is empty' }),
                a.map((f) =>
                  v.jsx(
                    n_,
                    {
            ...
            v.jsx('div', {
              ...
              children: v.jsx(Z1, { totalPrice: i(), totalItems: c() }),
            }),
          ],
        }),
      ],
  ...
  r_ = '_search_clix4_19',
  u_ = '_title_clix4_34',
  o_ = '_modelsCount_clix4_44',
  c_ = '_controls_clix4_52',
  f_ = '_controlsLeft_clix4_59',
  d_ = '_control_clix4_52',
  m_ = '_label_clix4_69',
  h_ = '_select_clix4_73',
  p_ = '_searchInput_clix4_94',
  nt = {
  ...
  v_ = () => {
    ...
    const A = N.useMemo(() => {
      ...
      j = N.useMemo(() => S.slice(0, c), [S, c]);
    return v.jsx('div', {
      className: nt['tablets-page'],
      children: v.jsxs('div', {
        className: nt['tablets-page__container'],
        children: [
          v.jsx(nn, {}),
          v.jsx('h1', { className: nt.title, children: 'Tablets' }),
          !h &&
            v.jsxs('p', {
          ...
          v.jsx('section', {
            className: nt['tablets-page__controls'],
            children: v.jsxs('div', {
          ...
          v.jsx('section', {
            className: nt['tablets-page__list'],
            children:
              h ? Array.from({ length: 8 }).map((T, M) => v.jsx(Zo, {}, M))
              : j.length > 0 ? j.map((T) => v.jsx(pa, { product: T }, T.id))
              : v.jsx(ko, { category: 'tablets' }),
          }),
        ],
      }),
    });
  ...
  g_ = '_home_185n1_9',
  y_ = '_container_185n1_20',
  __ = '_hero_185n1_36',
  b_ = '_hero__title_185n1_49',
  S_ = '_section_185n1_68',
  x_ = '_section__header_185n1_81',
  T_ = '_section__title_185n1_92',
  E_ = '_section__arrows_185n1_107',
  C_ = '_categories_185n1_178',
  fe = {
...
function $o(a = {}, r = {}) {
  ...
  Object.keys(r)
    ...
    .forEach((i) => {
      typeof a[i] > 'u' ?
        (a[i] = r[i])
      : mh(r[i]) && mh(a[i]) && Object.keys(r[i]).length > 0 && $o(a[i], r[i]);
    });
}
const Fh = {
  body: {},
...
function At(...a) {
  ...
  for (let i = 1; i < a.length; i += 1) {
    ...
    if (c != null && !j_(c)) {
      ...
      for (let h = 0, g = f.length; h < g; h += 1) {
        const d = f[h],
...
function Wh({ swiper: a, targetPosition: r, side: s }) {
  const i = ot(),
    c = -a.translate;
  let f = null,
    h;
  ...
  const d = r > c ? 'next' : 'prev',
    p = (y, A) => (d === 'next' && y >= A) || (d === 'prev' && y <= A),
    b = () => {
      ((h = new Date().getTime()), f === null && (f = h));
      const y = Math.max(Math.min((h - f) / g, 1), 0),
        A = 0.5 - Math.cos(y * Math.PI) / 2;
      let S = c + A * (r - c);
...
function R_(a, r) {
  ...
  return (
    !i &&
      ...
      ((i = [...r.assignedElements()].includes(a)), i || (i = D_(a, r))),
    i
  );
}
function Ys(a) {
...
function Vs(a, r = []) {
  ...
  return (s.classList.add(...(Array.isArray(r) ? r : A_(r))), s);
}
function w_(a, r) {
  const s = [];
...
function H_({ userAgent: a } = {}) {
  ...
  const b = c.match(/(iPod)(.*OS\s([\d_]+))?/),
    y = !p && c.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
    A = i === 'Win32';
  let S = i === 'MacIntel';
  const j = [
    '1024x1366',
  ...
  return (
    !p &&
      ...
      p || (p = [0, 1, '13_0_0']),
      (S = !1)),
    d && !A && ((f.os = 'android'), (f.android = !0)),
    (p || y || b) && ((f.os = 'ios'), (f.ios = !0)),
    f
  );
}
function tp(a = {}) {
  return (Mo || (Mo = H_(a)), Mo);
}
let Ao;
function U_() {
  const a = ot(),
...
function G_({ swiper: a, on: r, emit: s }) {
  const i = ot();
  let c = null,
    f = null;
  const h = () => {
      ...
      !a ||
        ...
        ((c = new ResizeObserver((b) => {
          f = i.requestAnimationFrame(() => {
            const { width: y, height: A } = a;
            let S = y,
              j = A;
            (b.forEach(({ contentBoxSize: T, contentRect: M, target: x }) => {
              (x && x !== a.el) ||
                ((S = M ? M.width : (T[0] || T).inlineSize),
                (j = M ? M.height : (T[0] || T).blockSize));
            }),
              (S !== y || j !== A) && h());
          });
        })),
...
function q_({ swiper: a, extendParams: r, on: s, emit: i }) {
  const c = [],
    f = ot(),
    h = (p, b = {}) => {
      const y = f.MutationObserver || f.WebkitMutationObserver,
        A = new y((S) => {
...
function X_() {
  ...
  const s = a.params,
    ...
    b = g ? a.virtual.slides.length : p.length;
  let y = [];
  const A = [],
    S = [];
  ...
  typeof T == 'function' && (T = s.slidesOffsetAfter.call(a));
  const M = a.snapGrid.length,
  ...
  : typeof D == 'string' && (D = parseFloat(D)),
    ...
    s.cssMode &&
      ...
      ln(i, '--swiper-slides-offset-after', `${T}px`)));
      ...
      if (g && s.slidesPerView === 'auto')
        ...
        if (
          ...
          if (oe && oe === 'border-box') H = pe + X + ee;
            ...
            const { clientWidth: z, offsetWidth: k } = F;
            H = pe + G + Z + X + ee + (k - z);
          }
        }
        ...
        ((H = (E - (s.slidesPerView - 1) * D) / s.slidesPerView),
          s.roundLengths && (H = Math.floor(H)),
  ...
  if (
    ((a.virtualSize = Math.max(a.virtualSize, E) + T),
    f &&
      h &&
      (s.effect === 'slide' || s.effect === 'coverflow') &&
      (i.style.width = `${a.virtualSize + D}px`),
    s.setWrapperSize &&
      (i.style[a.getDirectionLabel('width')] = `${a.virtualSize + D}px`),
    K && a.grid.updateWrapperSize(H, y),
    !s.centeredSlides)
  ) {
    ...
    if (F) {
      ...
      if (s.slidesPerView === 'auto') {
        ...
        for (
          let G = S.length - 1;
          G >= 0 && ((pe += S[G] + (G < S.length - 1 ? D : 0)), pe <= E);
          G -= 1
        )
          re = S.length - G;
    ...
    const ue = [];
    for (let re = 0; re < y.length; re += 1) {
      let pe = y[re];
      (s.roundLengths && (pe = Math.floor(pe)),
        F ? re <= P && ue.push(pe) : y[re] <= a.virtualSize - E && ue.push(pe));
    }
    ((y = ue),
      Math.floor(a.virtualSize - E) - Math.floor(y[y.length - 1]) > 1 &&
        (F || y.push(a.virtualSize - E)));
  }
  if (g && s.loop) {
    const J = S[0] + D;
    if (s.slidesPerGroup > 1) {
      ...
      for (let ue = 0; ue < F; ue += 1) y.push(y[y.length - 1] + P);
    }
    for (let F = 0; F < a.virtual.slidesBefore + a.virtual.slidesAfter; F += 1)
      (s.slidesPerGroup === 1 && y.push(y[y.length - 1] + J),
        A.push(A[A.length - 1] + J),
        (a.virtualSize += J));
  }
  if ((y.length === 0 && (y = [0]), D !== 0)) {
    const J =
  ...
  if (
    ...
    (ln(i, '--swiper-centered-offset-before', `${-y[0]}px`),
      ln(
        i,
  ...
  if (
    ...
    A.length !== x && a.emit('slidesGridLengthChange'),
...
function Q_(a) {
  ...
  const h = (g) => (i ? r.slides[r.getSlideIndexByData(g)] : r.slides[g]);
...
function k_(a = (this && this.translate) || 0) {
  const r = this,
    s = r.params,
  ...
  for (let d = 0; d < i.length; d += 1) {
    ...
    const y =
      ...
      T = S >= 0 && S <= r.size - r.slidesSizesGrid[d],
      M =
        (S >= 0 && S < r.size - 1) ||
        (j > 1 && j <= r.size) ||
        (S <= 0 && j >= r.size);
    (M && (r.visibleSlides.push(p), r.visibleSlidesIndexes.push(d)),
      hh(p, M, s.slideVisibleClass),
      hh(p, T, s.slideFullyVisibleClass),
      (p.progress = c ? -y : y),
      (p.originalProgress = c ? -A : A));
  }
}
function $_(a) {
  const r = this;
  ...
  let { progress: c, isBeginning: f, isEnd: h, progressLoop: g } = r;
  const d = f,
    p = h;
  if (i === 0) ((c = 0), (f = !0), (h = !0));
  else {
    ...
    const b = Math.abs(a - r.minTranslate()) < 1,
      y = Math.abs(a - r.maxTranslate()) < 1;
    ((f = b || c <= 0), (h = y || c >= 1), b && (c = 0), y && (c = 1));
  }
  if (s.loop) {
    const b = r.getSlideIndexByData(0),
      y = r.getSlideIndexByData(r.slides.length - 1),
      A = r.slidesGrid[b],
      S = r.slidesGrid[y],
      j = r.slidesGrid[r.slidesGrid.length - 1],
      T = Math.abs(a);
    (T >= A ? (g = (T - A) / j) : (g = (T + j - S) / j), g > 1 && (g -= 1));
  }
  (Object.assign(r, { progress: c, progressLoop: g, isBeginning: f, isEnd: h }),
...
function K_() {
  const a = this,
    ...
    g = (y) => Kt(i, `.${s.slideClass}${y}, swiper-slide${y}`)[0];
  let d, p, b;
  if (f)
    if (s.loop) {
      let y = c - a.virtual.slidesBefore;
      (y < 0 && (y = a.virtual.slides.length + y),
        y >= a.virtual.slides.length && (y -= a.virtual.slides.length),
        (d = g(`[data-swiper-slide-index="${y}"]`)));
    } else d = g(`[data-swiper-slide-index="${c}"]`);
  else
    h ?
      ((d = r.find((y) => y.column === c)),
      (b = r.find((y) => y.column === c + 1)),
      (p = r.find((y) => y.column === c - 1)))
    : (d = r[c]);
  (d &&
    (h ||
      ((b = L_(d, `.${s.slideClass}, swiper-slide`)[0]),
      s.loop && !b && (b = r[0]),
      (p = w_(d, `.${s.slideClass}, swiper-slide`)[0]),
      s.loop && !p === 0 && (p = r[r.length - 1]))),
    r.forEach((y) => {
      (No(y, y === d, s.slideActiveClass),
        No(y, y === b, s.slideNextClass),
        No(y, y === p, s.slidePrevClass));
    }),
    a.emitSlidesClasses());
}
const Hs = (a, r) => {
  ...
  Bo = (a) => {
    ...
    if (a.params.grid && a.params.grid.rows > 1) {
      const h = c,
        g = [h - r];
      (g.push(...Array.from({ length: r }).map((d, p) => h + i + p)),
        a.slides.forEach((d, p) => {
          g.includes(d.column) && zo(a, p);
        }));
      return;
    }
    const f = c + i - 1;
...
function F_(a) {
  const r = this,
    ...
    { snapGrid: i, params: c, activeIndex: f, realIndex: h, snapIndex: g } = r;
  let d = a,
    p;
  const b = (S) => {
  ...
  if ((typeof d > 'u' && (d = J_(r)), i.indexOf(s) >= 0)) p = i.indexOf(s);
  else {
  ...
  const y = r.grid && c.grid && c.grid.rows > 1;
  let A;
  if (r.virtual && c.virtual.enabled) c.loop ? (A = b(d)) : (A = d);
  else if (y) {
    const S = r.slides.find((T) => T.column === d);
    let j = parseInt(S.getAttribute('data-swiper-slide-index'), 10);
    (Number.isNaN(j) && (j = Math.max(r.slides.indexOf(S), 0)),
      (A = Math.floor(j / c.grid.rows)));
  } else if (r.slides[d]) {
    const S = r.slides[d].getAttribute('data-swiper-slide-index');
    S ? (A = parseInt(S, 10)) : (A = d);
  } else A = d;
  (Object.assign(r, {
    previousSnapIndex: g,
    snapIndex: p,
    ...
    (r.initialized || r.params.runCallbacksOnInit) &&
      (h !== A && r.emit('realIndexChange'), r.emit('slideChange')));
}
function P_(a, r) {
  const s = this,
    i = s.params;
...
var W_ = {
  ...
  updateSlides: X_,
  updateAutoHeight: Q_,
  updateSlidesOffset: Z_,
  updateSlidesProgress: k_,
  updateProgress: $_,
  updateSlidesClasses: K_,
  updateActiveIndex: F_,
  updateClickedSlide: P_,
};
function I_(a = this.isHorizontal() ? 'x' : 'y') {
  const r = this,
...
function eb(a, r) {
  ...
  let b;
  const y = s.maxTranslate() - s.minTranslate();
  (y === 0 ? (b = 0) : (b = (a - s.minTranslate()) / y),
...
function ab(a = 0, r = this.params.speed, s = !0, i = !0, c) {
  const f = this,
    { params: h, wrapperEl: g } = f;
  ...
  if (
    ...
    const y = f.isHorizontal();
    if (r === 0) g[y ? 'scrollLeft' : 'scrollTop'] = -b;
    else {
      if (!f.support.smoothScroll)
        return (
          Wh({ swiper: f, targetPosition: -b, side: y ? 'left' : 'top' }),
          !0
        );
      g.scrollTo({ [y ? 'left' : 'top']: -b, behavior: 'smooth' });
    }
    return !0;
  }
  return (
    ...
    : (f.setTransition(r),
      ...
      f.animating ||
        ...
        f.onTranslateToWrapperTransitionEnd ||
          (f.onTranslateToWrapperTransitionEnd = function (A) {
            !f ||
              f.destroyed ||
              (A.target === this &&
...
function ap({ swiper: a, runCallbacks: r, direction: s, step: i }) {
...
function sb(a = !0, r) {
  ...
  i.cssMode ||
    ...
    ap({ swiper: s, runCallbacks: a, direction: r, step: 'Start' }));
}
function rb(a = !0, r) {
  const s = this,
    { params: i } = s;
  ((s.animating = !1),
    !i.cssMode &&
      (s.setTransition(0),
      ap({ swiper: s, runCallbacks: a, direction: r, step: 'End' })));
}
var ub = { setTransition: ib, transitionStart: sb, transitionEnd: rb };
function ob(a = 0, r, s = !0, i, c) {
  ...
  const T = Math.min(f.params.slidesPerGroupSkip, h);
  let M = T + Math.floor((h - T) / f.params.slidesPerGroup);
  ...
  : h < y ? (E = 'prev')
  : (E = 'reset');
  const D = f.virtual && f.params.virtual.enabled;
  if (!(D && c) && ((A && -x === f.translate) || (!A && x === f.translate)))
    return (
  ...
  if (g.cssMode) {
    ...
    if (r === 0)
      (D &&
        ...
        D && !f._cssModeVirtualInitialSet && f.params.initialSlide > 0 ?
      ...
      if (!f.support.smoothScroll)
        return (
          Wh({ swiper: f, targetPosition: H, side: K ? 'left' : 'top' }),
          !0
        );
  ...
  const I = lp().isSafari;
  return (
    D && !c && I && f.isElement && f.virtual.update(!1, !1, h),
    f.setTransition(r),
    f.setTranslate(x),
    f.updateActiveIndex(h),
    f.updateSlidesClasses(),
...
function cb(a = 0, r, s = !0, i) {
  ...
  if (c.params.loop)
    if (c.virtual && c.params.virtual.enabled) h = h + c.virtual.slidesBefore;
      ...
      let g;
      if (f) {
        const T = h * c.params.grid.rows;
        g = c.slides.find(
          (M) => M.getAttribute('data-swiper-slide-index') * 1 === T,
        ).column;
      } else g = c.getSlideIndexByData(h);
      const d =
      ...
      let j = d - g < S;
      if (
        (A && (j = j || g < Math.ceil(S / 2)),
        i && A && c.params.slidesPerView !== 'auto' && !f && (j = !1),
        j)
      ) {
        const T =
          A ?
        ...
        c.loopFix({
          direction: T,
          slideTo: !0,
          activeSlideIndex: T === 'next' ? g + 1 : g - d + 1,
...
function db(a, r = !0, s) {
  ...
  const y = g ? i.translate : -i.translate;
  function A(E) {
    return E < 0 ? -Math.floor(Math.abs(E)) : Math.floor(E);
  }
  const S = A(y),
    j = f.map((E) => A(E)),
    T = c.freeMode && c.freeMode.enabled;
  let M = f[j.indexOf(S) - 1];
  if (typeof M > 'u' && (c.cssMode || T)) {
    let E;
    (f.forEach((D, V) => {
      S >= D && (E = V);
    }),
      typeof E < 'u' && (M = T ? f[E] : f[E > 0 ? E - 1 : E]));
  }
  let x = 0;
  if (
    (typeof M < 'u' &&
...
function gb(a, r) {
  ...
  const f = () => {
      Kt(c, `.${i.slideClass}, swiper-slide`).forEach((j, T) => {
        j.setAttribute('data-swiper-slide-index', T);
      });
    },
    h = () => {
  ...
  i.loopAddBlankSlides && (i.slidesPerGroup > 1 || g) && h();
  const d = i.slidesPerGroup * (g ? i.grid.rows : 1),
    p = s.slides.length % d !== 0,
    b = g && s.slides.length % i.grid.rows !== 0,
    y = (S) => {
      for (let j = 0; j < S; j += 1) {
        const T =
          s.isElement ?
  ...
  if (p) {
    if (i.loopAddBlankSlides) {
      ...
      (y(S), s.recalcSlides(), s.updateSlides());
    } else
      Ys(
  ...
  const A = i.centeredSlides || !!i.slidesOffsetBefore || !!i.slidesOffsetAfter;
  s.loopFix({ slideRealIndex: a, direction: A ? void 0 : 'next', initial: r });
}
function yb({
  slideRealIndex: a,
  slideTo: r = !0,
  ...
  D === 'auto' ?
    (D = d.slidesPerViewDynamic())
  : ((D = Math.ceil(parseFloat(S.slidesPerView, 10))),
    E && D % 2 === 0 && (D = D + 1));
  const V = S.slidesPerGroupAuto ? D : S.slidesPerGroup;
  let $ = E ? Math.max(V, Math.ceil(D / 2)) : V;
  ($ % V !== 0 && ($ += V - ($ % V)),
    ($ += S.loopAdditionalSlides),
    (d.loopedSlides = $));
  const I = d.grid && S.grid && S.grid.rows > 1;
  p.length < D + $ || (d.params.effect === 'cards' && p.length < D + $ * 2) ?
    Ys(
  ...
  let re = 0,
    pe = 0;
  const Z = (I ? p[c].column : c) + (E && typeof i > 'u' ? -D / 2 + 0.5 : 0);
  if (Z < $) {
    re = Math.max($ - Z, V);
    for (let X = 0; X < $ - Z; X += 1) {
      ...
      if (I) {
        ...
        for (let z = p.length - 1; z >= 0; z -= 1)
          p[z].column === oe && K.push(z);
      } else K.push(ne - ee - 1);
    }
  } else if (Z + D > ne - $) {
    ((pe = Math.max(Z - (ne - $ * 2), V)),
      J && (pe = Math.max(pe, D - ne + x + 1)));
    for (let X = 0; X < pe; X += 1) {
      const ee = X - Math.floor(X / ne) * ne;
      I ?
        p.forEach((oe, z) => {
          oe.column === ee && H.push(z);
        })
      : H.push(ee);
    }
  }
...
var bb = { loopCreate: gb, loopFix: yb, loopDestroy: _b };
function Sb(a) {
  const r = this;
  if (
...
var Tb = { setGrabCursor: Sb, unsetGrabCursor: xb };
function Eb(a, r = this) {
  function s(i) {
...
function Cb(a) {
  ...
  if (i.type === 'touchstart') {
    ph(r, i, i.targetTouches[0].pageX);
    return;
  }
  const { params: f, touches: h, enabled: g } = r;
  if (
    !g ||
  ...
  let d = i.target;
  if (
    (f.touchEventsTarget === 'wrapper' && !R_(d, r.wrapperEl)) ||
  ...
  const y = f.noSwipingSelector ? f.noSwipingSelector : `.${f.noSwipingClass}`,
    A = !!(i.target && i.target.shadowRoot);
  if (f.noSwiping && (A ? Eb(y, d) : d.closest(y))) {
    r.allowClick = !0;
    return;
  }
  ...
  (d.matches(c.focusableElements) &&
    ((T = !1), d.nodeName === 'SELECT' && (c.isTouched = !1)),
    s.activeElement &&
  ...
  const M = T && r.allowTouchMove && f.touchStartPreventDefault;
  ((f.touchStartForcePreventDefault || M) &&
    !d.isContentEditable &&
    i.preventDefault(),
    f.freeMode &&
      f.freeMode.enabled &&
...
function Mb(a) {
  const r = Jt(),
    s = this,
    i = s.touchEventsData,
    { params: c, touches: f, rtlTranslate: h, enabled: g } = s;
  ...
  if (d.preventedByNestedSwiper) {
    ((f.startX = b), (f.startY = y));
    return;
  }
  if (!s.allowTouchMove) {
    (d.target.matches(i.focusableElements) || (s.allowClick = !1),
      i.isTouched &&
        (Object.assign(f, { startX: b, startY: y, currentX: b, currentY: y }),
        (i.touchStartTime = qs())));
    return;
  }
  if (c.touchReleaseOnEdges && !c.loop)
    if (s.isVertical()) {
      if (
        (y < f.startY && s.translate <= s.maxTranslate()) ||
        (y > f.startY && s.translate >= s.minTranslate())
      ) {
  ...
  if (s.params.threshold && Math.sqrt(A ** 2 + S ** 2) < s.params.threshold)
    return;
  if (typeof i.isScrolling > 'u') {
    ...
    (
      ...
      (i.isScrolling = !1)
    : A * A + S * S >= 25 &&
      (($ = (Math.atan2(Math.abs(S), Math.abs(A)) * 180) / Math.PI),
      (i.isScrolling =
  ...
  let j = s.isHorizontal() ? A : S,
    T = s.isHorizontal() ? f.currentX - f.previousX : f.currentY - f.previousY;
  (c.oneWayMovement &&
    ((j = Math.abs(j) * (h ? 1 : -1)), (T = Math.abs(T) * (h ? 1 : -1))),
    (f.diff = j),
    (j *= c.touchRatio),
    h && ((j = -j), (T = -T)));
  const M = s.touchesDirection;
  ((s.swipeDirection = j > 0 ? 'prev' : 'next'),
    (s.touchesDirection = T > 0 ? 'prev' : 'next'));
...
function Ab(a) {
  ...
  for (
    let $ = 0;
    $ < p.length;
    $ += $ < h.slidesPerGroupSkip ? 1 : h.slidesPerGroup
  ) {
    const I = $ < h.slidesPerGroupSkip - 1 ? 1 : h.slidesPerGroup;
    typeof p[$ + I] < 'u' ?
      (j || (S >= p[$] && S < p[$ + I])) && ((T = $), (M = p[$ + I] - p[$]))
    : (j || S >= p[$]) && ((T = $), (M = p[p.length - 1] - p[p.length - 2]));
  }
  let x = null,
    E = null;
  h.rewind &&
    ...
    : r.isEnd && (x = 0));
  const D = (S - p[T]) / M,
    V = T < h.slidesPerGroupSkip - 1 ? 1 : h.slidesPerGroup;
  if (A > h.longSwipesMs) {
    if (!h.longSwipes) {
    ...
    (r.swipeDirection === 'next' &&
      (D >= h.longSwipesRatio ?
        r.slideTo(h.rewind && r.isEnd ? x : T + V)
      : r.slideTo(T)),
      r.swipeDirection === 'prev' &&
        (D > 1 - h.longSwipesRatio ? r.slideTo(T + V)
        : E !== null && D < 0 && Math.abs(D) > h.longSwipesRatio ? r.slideTo(E)
        : r.slideTo(T)));
  } else {
    if (!h.shortSwipes) {
      r.slideTo(r.activeIndex);
    ...
    (
      ...
      i.target === r.navigation.nextEl ?
        r.slideTo(T + V)
      : r.slideTo(T)
    : (r.swipeDirection === 'next' && r.slideTo(x !== null ? x : T + V),
      r.swipeDirection === 'prev' && r.slideTo(E !== null ? E : T));
  }
}
function vh() {
  const a = this,
...
const np = (a, r) => {
  ...
  !c ||
    ...
    : a[p]('observerUpdate', vh, !0),
    c[d]('load', a.onLoad, { capture: !0 }));
};
function Db() {
  const a = this,
    { params: r } = a;
  ((a.onTouchStart = Cb.bind(a)),
    (a.onTouchMove = Mb.bind(a)),
    (a.onTouchEnd = Ab.bind(a)),
    (a.onDocumentTouchStart = jb.bind(a)),
    r.cssMode && (a.onScroll = zb.bind(a)),
    (a.onClick = Nb.bind(a)),
    (a.onLoad = Ob.bind(a)),
    np(a, 'on'));
}
...
var wb = { attachEvents: Db, detachEvents: Rb };
const gh = (a, r) => a.grid && r.grid && r.grid.rows > 1;
function Lb() {
  const a = this,
  ...
  const y = (p in f ? f[p] : void 0) || a.originalParams,
    A = gh(a, i),
    S = gh(a, y),
  ...
  : !A &&
    ...
    ((y.grid.fill && y.grid.fill === 'column') ||
      (!y.grid.fill && i.grid.fill === 'column')) &&
      c.classList.add(`${i.containerModifierClass}grid-column`),
    a.emitContainerClasses()),
    j && !T ? a.unsetGrabCursor() : !j && T && a.setGrabCursor(),
    ['navigation', 'pagination', 'scrollbar'].forEach((I) => {
      if (typeof y[I] > 'u') return;
      const K = i[I] && i[I].enabled,
        H = y[I] && y[I].enabled;
      (K && !H && a[I].disable(), !K && H && a[I].enable());
    }));
  const x = y.direction && y.direction !== i.direction,
    E = i.loop && (y.slidesPerView !== i.slidesPerView || x),
    D = i.loop;
  (x && s && a.changeDirection(), At(a.params, y));
...
function Bb(a, r = 'window', s) {
  ...
  h.sort((g, d) => parseInt(g.value, 10) - parseInt(d.value, 10));
  for (let g = 0; g < h.length; g += 1) {
    const { point: d, value: p } = h[g];
    r === 'window' ?
...
var Hb = { setBreakpoint: Lb, getBreakpoint: Bb };
function Ub(a, r) {
  const s = [];
  return (
    a.forEach((i) => {
...
var Yb = { addClasses: Gb, removeClasses: qb };
function Vb() {
  const a = this,
...
let Ko = class vl {
  constructor(...r) {
    ...
    ((f.__swiper__ = !0),
      (f.support = ep()),
      (f.device = tp({ userAgent: i.userAgent })),
      (f.browser = lp()),
      (f.eventsListeners = {}),
  ...
  slidesPerViewDynamic(r = 'current', s = !1) {
    ...
    if (c.centeredSlides) {
      let y = f[p] ? Math.ceil(f[p].swiperSlideSize) : 0,
        A;
      for (let S = p + 1; S < f.length; S += 1)
        f[S] &&
          !A &&
          ((y += Math.ceil(f[S].swiperSlideSize)), (b += 1), y > d && (A = !0));
      for (let S = p - 1; S >= 0; S -= 1)
        f[S] &&
          !A &&
          ((y += f[S].swiperSlideSize), (b += 1), y > d && (A = !0));
    } else if (r === 'current')
      for (let y = p + 1; y < f.length; y += 1)
        (s ? h[y] + g[y] - h[p] < d : h[y] - h[p] < d) && (b += 1);
    else for (let y = p - 1; y >= 0; y -= 1) h[p] - h[y] < d && (b += 1);
    return b;
  }
  update() {
    const r = this;
    ...
    function c() {
      const h = r.rtlTranslate ? r.translate * -1 : r.translate,
        g = Math.min(Math.max(h, r.maxTranslate()), r.minTranslate());
  ...
  mount(r) {
    ...
    return (
      !h &&
        ...
        ((h = Vs('div', s.params.wrapperClass)),
        i.append(h),
  ...
  destroy(r = !0, s = !0) {
    const i = this,
      { params: c, el: f, wrapperEl: h, slides: g } = i;
    return (
      typeof i.params > 'u' ||
        i.destroyed ||
        ...
        r !== !1 &&
          (i.el && typeof i.el != 'string' && (i.el.swiper = null), N_(i)),
        (i.destroyed = !0)),
      null
    );
  }
...
Object.keys(Oo).forEach((a) => {
  Object.keys(Oo[a]).forEach((r) => {
    Ko.prototype[r] = Oo[a][r];
  });
});
Ko.use([G_, q_]);
const ip = [
...
function kb({
  ...
  (i.includes('loop') &&
    ...
    T && j.init() && j.update(!0),
    M && (a.controller.control = p.controller.control),
    x &&
      (a.isElement &&
        (!g || typeof g == 'string') &&
...
function $b(a = {}, r = !0) {
  const s = { on: {} },
    i = {},
    c = {};
  (an(s, Ho), (s._emitClasses = !0), (s.init = !1));
  const f = {},
    h = ip.map((d) => d.replace(/_/, '')),
    g = Object.assign({}, a);
  return (
...
function fp(a) {
  const r = [];
  return (
    $e.Children.toArray(a).forEach((s) => {
      cp(s) ?
        r.push(s)
      : s.props &&
        s.props.children &&
        fp(s.props.children).forEach((i) => r.push(i));
    }),
    r
  );
}
...
function Wb(a, r, s) {
  ...
  const i = (b) => {
      let y = b;
      return (
        b < 0 ? (y = r.length + b) : y >= r.length && (y = y - r.length),
        y
      );
    },
    c =
    ...
    p = [];
  for (let b = g; b < d; b += 1) b >= f && b <= h && p.push(r[i(b)]);
  return p.map((b, y) =>
    $e.cloneElement(b, {
      swiper: a,
      style: c,
      key: b.props.virtualIndex || b.key || `slide-${y}`,
    }),
  );
}
function si(a, r) {
...
const yh = N.createContext(null),
  Ib = N.createContext(null),
  dp = N.forwardRef(
    (
      {
        className: a,
      ...
      const [d, p] = N.useState('swiper'),
        ...
        $ = N.useRef(null),
        I = N.useRef(null),
        { params: K, passedParams: H, rest: ne, events: J } = $b(f),
        { slides: F, slots: P } = Pb(i),
        ue = () => {
          S(!A);
        };
      Object.assign(K.on, {
      ...
      const re = () => {
        ...
        if (
          ...
          (an(M.current.params.virtual, ee),
            an(M.current.originalParams.virtual, ee));
        }
      };
      (T.current || re(), M.current && M.current.on('_beforeBreakpoint', ue));
      const pe = () => {
          g ||
            !J ||
            !M.current ||
      ...
      (N.useEffect(() => () => {
        M.current && M.current.off('_beforeBreakpoint', ue);
      }),
        N.useEffect(() => {
          !j.current &&
            M.current &&
            (M.current.emitSlidesClasses(), (j.current = !0));
        }),
        si(() => {
          if ((h && (h.current = T.current), !!T.current))
            return (
              M.current.destroyed && re(),
              Kb(
                {
                  el: T.current,
                  nextEl: D.current,
              ...
              c && !M.current.destroyed && c(M.current),
              () => {
        ...
        si(() => {
          pe();
          const X = Jb(H, x.current, F, E.current, (ee) => ee.key);
          return (
            (x.current = H),
            (E.current = F),
            X.length &&
      ...
      function Z() {
        return K.virtual ?
            Wb(M.current, F, b)
          : F.map((X, ee) =>
              $e.cloneElement(X, { swiper: M.current, swiperSlideIndex: ee }),
            );
      }
      return $e.createElement(
        r,
        Qs({ ref: T, className: op(`${d}${a ? ` ${a}` : ''}`) }, ne),
        $e.createElement(
          Ib.Provider,
          { value: M.current },
          P['container-start'],
          ...
          up(K) &&
            $e.createElement('div', { ref: I, className: 'swiper-scrollbar' }),
          rp(K) &&
            $e.createElement('div', { ref: $, className: 'swiper-pagination' }),
          P['container-end'],
        ),
      );
    },
  );
dp.displayName = 'Swiper';
const Us = N.forwardRef(
  (
    ...
    (si(() => {
      if (
        (typeof g < 'u' && (b.current.swiperSlideIndex = g),
        p && (p.current = b.current),
        !(!b.current || !i))
      ) {
        if (i.destroyed) {
          y !== 'swiper-slide' && A('swiper-slide');
          return;
        }
        return (
          i.on('_slideClass', T),
          () => {
            i && i.off('_slideClass', T);
          }
        );
      }
    }),
      si(() => {
        i && b.current && !i.destroyed && A(i.getSlideClasses(b.current));
      }, [i]));
    const M = {
...
function eS({ swiper: a, extendParams: r, on: s, emit: i }) {
  (r({
    navigation: {
      nextEl: null,
      prevEl: null,
    ...
    (a.navigation = { nextEl: null, prevEl: null, arrowSvg: _h }));
  function c(S) {
    let j;
    return (
        S &&
  ...
  function f(S, j) {
    ...
    ((S = Pe(S)),
      S.forEach((M) => {
        M &&
          (M.classList[j ? 'add' : 'remove'](...T.disabledClass.split(' ')),
          M.tagName === 'BUTTON' && (M.disabled = j),
          a.params.watchOverflow &&
            a.enabled &&
            M.classList[a.isLocked ? 'add' : 'remove'](T.lockClass));
      }));
  }
  function h() {
  ...
  function p() {
    ...
    let j = c(S.nextEl),
      T = c(S.prevEl);
    (Object.assign(a.navigation, { nextEl: j, prevEl: T }),
      (j = Pe(j)),
      (T = Pe(T)));
    const M = (x, E) => {
      if (x) {
        if (
          ...
          (ui(D, _h), x.appendChild(D.querySelector('svg')), D.remove());
        }
        x.addEventListener('click', E === 'next' ? d : g);
      }
      !a.enabled && x && x.classList.add(...S.lockClass.split(' '));
    };
    (j.forEach((x) => M(x, 'next')), T.forEach((x) => M(x, 'prev')));
  }
  function b() {
    let { nextEl: S, prevEl: j } = a.navigation;
    ((S = Pe(S)), (j = Pe(j)));
    const T = (M, x) => {
      (M.removeEventListener('click', x === 'next' ? d : g),
        M.classList.remove(...a.params.navigation.disabledClass.split(' ')));
    };
    (S.forEach((M) => T(M, 'next')), j.forEach((M) => T(M, 'prev')));
  }
  (s('init', () => {
    a.params.navigation.enabled === !1 ? A() : (p(), h());
  }),
    ...
    s('enable disable', () => {
      let { nextEl: S, prevEl: j } = a.navigation;
      if (((S = Pe(S)), (j = Pe(j)), a.enabled)) {
        h();
        return;
      }
      [...S, ...j]
        .filter((T) => !!T)
        .forEach((T) => T.classList.add(a.params.navigation.lockClass));
    }),
    s('click', (S, j) => {
      let { nextEl: T, prevEl: M } = a.navigation;
      ((T = Pe(T)), (M = Pe(M)));
      const x = j.target;
      let E = M.includes(x) || T.includes(x);
      if (a.isElement && !E) {
        const D = j.path || (j.composedPath && j.composedPath());
        D && (E = D.find((V) => T.includes(V) || M.includes(V)));
      }
      if (a.params.navigation.hideOnClick && !E) {
        ...
        let D;
        (T.length ?
          (D = T[0].classList.contains(a.params.navigation.hiddenClass))
        : M.length &&
          (D = M[0].classList.contains(a.params.navigation.hiddenClass)),
          i(D === !0 ? 'navigationShow' : 'navigationHide'),
          [...T, ...M]
            .filter((V) => !!V)
            .forEach((V) =>
...
function tS({ swiper: a, extendParams: r, on: s, emit: i }) {
  ...
  function d(x, E) {
    const { bulletActiveClass: D } = a.params.pagination;
    x &&
      ((x = x[`${E === 'prev' ? 'previous' : 'next'}ElementSibling`]),
      x &&
        (x.classList.add(`${D}-${E}`),
        (x = x[`${E === 'prev' ? 'previous' : 'next'}ElementSibling`]),
        x && x.classList.add(`${D}-${E}-${E}`)));
  }
  function p(x, E, D) {
    if (((x = x % D), (E = E % D), E === x + 1)) return 'next';
  ...
  function b(x) {
    ...
    if (!E) return;
    x.preventDefault();
    const D = Xs(E) * a.params.slidesPerGroup;
    if (a.params.loop) {
      if (a.realIndex === D) return;
      const V = p(a.realIndex, D, a.slides.length);
      V === 'next' ? a.slideNext()
    ...
    if (
      ...
      if (
        ...
        H.forEach((P) => {
          const ue = Xs(P);
          (ue === V ?
            P.classList.add(...E.bulletActiveClass.split(' '))
          : a.isElement && P.setAttribute('part', 'bullet'),
            E.dynamicBullets &&
              (ue >= ne &&
                ue <= J &&
                P.classList.add(...`${E.bulletActiveClass}-main`.split(' ')),
              ue === ne && d(P, 'prev'),
              ue === J && d(P, 'next')));
        });
      else {
        const P = H[V];
        if (
          (P && P.classList.add(...E.bulletActiveClass.split(' ')),
          a.isElement &&
            H.forEach((ue, re) => {
      ...
      if (E.dynamicBullets) {
        const P = Math.min(H.length, E.dynamicMainBullets + 4),
          ue = (f * P - f) / 2 - F * f,
          re = x ? 'right' : 'left';
        H.forEach((pe) => {
  ...
  function A() {
    ...
    (x.type === 'fraction' &&
      ...
      x.type !== 'custom' && i('paginationRender', D[0]));
  }
  function S() {
    a.params.pagination = mp(
      a,
    ...
    (typeof x.el == 'string' && a.isElement && (E = a.el.querySelector(x.el)),
      ...
      !(!E || E.length === 0) &&
        (a.params.uniqueNavElements &&
          ...
          E.length > 1 && (E = E.find((D) => Ih(D, '.swiper')[0] === a.el))),
        ...
        E.forEach((D) => {
          (x.type === 'bullets' &&
            x.clickable &&
            D.classList.add(...(x.clickableClass || '').split(' ')),
            D.classList.add(x.modifierClass + x.type),
            D.classList.add(
              a.isHorizontal() ? x.horizontalClass : x.verticalClass,
            ),
            x.type === 'bullets' &&
              x.dynamicBullets &&
              (D.classList.add(`${x.modifierClass}${x.type}-dynamic`),
              (h = 0),
              x.dynamicMainBullets < 1 && (x.dynamicMainBullets = 1)),
            x.type === 'progressbar' &&
              x.progressbarOpposite &&
              D.classList.add(x.progressbarOppositeClass),
            x.clickable && D.addEventListener('click', b),
            a.enabled || D.classList.add(x.lockClass));
        })));
  }
  function j() {
    const x = a.params.pagination;
    ...
    (E &&
      ((E = Pe(E)),
      E.forEach((D) => {
        (D.classList.remove(x.hiddenClass),
          D.classList.remove(x.modifierClass + x.type),
          D.classList.remove(
            a.isHorizontal() ? x.horizontalClass : x.verticalClass,
          ),
          x.clickable &&
            (D.classList.remove(...(x.clickableClass || '').split(' ')),
            D.removeEventListener('click', b)));
      })),
      a.pagination.bullets &&
        a.pagination.bullets.forEach((D) =>
          D.classList.remove(...x.bulletActiveClass.split(' ')),
        ));
  }
  (s('changeDirection', () => {
    ...
    ((E = Pe(E)),
      E.forEach((D) => {
        (D.classList.remove(x.horizontalClass, x.verticalClass),
          D.classList.add(
            a.isHorizontal() ? x.horizontalClass : x.verticalClass,
          ));
      }));
    ...
    s('init', () => {
      a.params.pagination.enabled === !1 ? M() : (S(), A(), y());
    }),
    s('activeIndexChange', () => {
      typeof a.snapIndex > 'u' && y();
    }),
    s('snapIndexChange', () => {
      y();
    }),
    ...
    s('click', (x, E) => {
      const D = E.target,
        V = Pe(a.pagination.el);
      if (
        a.params.pagination.el &&
        a.params.pagination.hideOnClick &&
        V &&
        V.length > 0 &&
        !D.classList.contains(a.params.pagination.bulletClass)
      ) {
        if (
          a.navigation &&
          ((a.navigation.nextEl && D === a.navigation.nextEl) ||
            (a.navigation.prevEl && D === a.navigation.prevEl))
        )
          return;
...
function lS({ swiper: a, extendParams: r, on: s, emit: i, params: c }) {
  ...
  function x(Z) {
    !a ||
      ...
      (Z.target === a.wrapperEl &&
        ...
        !(M || (Z.detail && Z.detail.bySwiperTouchMove)) && ne()));
  }
  const E = () => {
      if (a.destroyed || !a.autoplay.running) return;
      a.autoplay.paused ? (y = !0) : y && ((d = p), (y = !1));
    ...
    J = () => {
      if (a.destroyed || !a.autoplay.running) return;
      const Z = Jt();
      (Z.visibilityState === 'hidden' && ((T = !0), H(!0)),
        Z.visibilityState === 'visible' && ne());
    },
    F = (Z) => {
      Z.pointerType === 'mouse' &&
        ((T = !0), (M = !0), !(a.animating || a.autoplay.paused) && H(!0));
    },
    P = (Z) => {
      Z.pointerType === 'mouse' && ((M = !1), a.autoplay.paused && ne());
    },
    ue = () => {
  ...
  (s('init', () => {
    ...
    s('touchEnd', () => {
      if (!(a.destroyed || !a.autoplay.running || !A)) {
        if (
          (clearTimeout(j),
          clearTimeout(f),
...
const aS = () =>
  ...
  nS = '_loader_16313_14',
  iS = { loader: nS },
  hp = () => v.jsx('span', { className: iS.loader }),
  sS = () => {
    const [a, r] = N.useState([]),
      [s, i] = N.useState([]),
      [c, f] = N.useState([]),
                ...
                children: [
                  ...
                  v.jsx('div', {
                    ...
                    children: v.jsx('div', {
                      ...
                      children: S.map((M) => v.jsx(pa, { product: M }, M.id)),
                    }),
                  }),
                ],
              }),
              ...
              v.jsxs('section', {
                ...
                children: [
                  ...
                  v.jsx('div', {
                    ...
                    children: v.jsx('div', {
                      className: fe['products-slider__track'],
                      children: j.map((M) => v.jsx(pa, { product: M }, M.id)),
                    }),
                  }),
                ],
              }),
      ...
      i = async () => {
        ...
        try {
          const c = JSON.parse(localStorage.getItem('favorites') || '[]'),
            [f, h, g] = await Promise.all([$s(), Ks(), Js()]),
            p = [...f, ...h, ...g].filter((b) => c.includes('' + b.id));
          r(p);
        } catch (c) {
        ...
        (function () {
          ...
          function i(f) {
            ...
            if (
              ...
              return f.toString();
            var h = '';
            for (var g in f) r.call(f, g) && f[g] && (h = c(h, g));
            return h;
          }
          function c(f, h) {
            return (
...
const Sh = xh(cS),
  fS = (a) => {
    ...
    return v.jsx(Zl, {
      to: s,
      className: Sh('color-link', { 'color-link--active': i }),
      children: v.jsx('span', {
        className: Sh('color-link__circle', {
        ...
        v.jsx('div', {
          ...
          children: v.jsx('ul', {
            ...
            children: r.map((d) => {
              const p = g(c, d),
                b = `/${h}/${p}`,
                y = d.toLowerCase().replace(/\s+/g, '');
              return v.jsx(
                'li',
                {
                  className: 'product-options__item',
                  children: v.jsx(fS, { to: b, color: y, selected: s === d }),
                },
                d,
              );
            }),
  ...
  mS = ({ priceRegular: a, priceDiscount: r }) =>
    v.jsxs('div', {
      className: 'purchase',
      children: [
        v.jsxs('div', {
  ...
  gS = ({ product: a, onCapacityChange: r }) =>
    v.jsxs('div', {
      className: 'product-card',
      children: [
        v.jsx('div', {
          className: 'product-card__gallery',
          children: v.jsx(uS, { images: a.images, name: a.name }),
        }),
        v.jsxs('div', {
        ...
        v.jsx('div', {
          ...
          children: v.jsx(hS, { description: a.description }),
        }),
        v.jsx('div', {
  ...
  yS = () => {
    const { category: a, productId: r } = qo(),
      s = Lh(),
      [i, c] = N.useState(null),
      [f, h] = N.useState(!0),
      [g, d] = N.useState(!1),
    ...
    return (
      f ? v.jsx('div', { className: 'loader-wrapper', children: v.jsx(hp, {}) })
      : g || !i ?
        v.jsx('div', {
      ...
      : v.jsxs('div', {
          ...
          children: [
            ...
            v.jsx(gS, { product: i, onCapacityChange: b }),
          ],
        })
    );
  },
    ...
    v.jsxs('div', {
      ...
      children: [
        ...
        v.jsx('div', {
          ...
          children: v.jsxs(Q0, {
            children: [
              v.jsx(pl, { path: '/', element: v.jsx(sS, {}) }),
              v.jsx(pl, { path: '/phones', element: v.jsx(E1, {}) }),
              v.jsx(pl, { path: '/tablets', element: v.jsx(v_, {}) }),
              v.jsx(pl, { path: '/accessories', element: v.jsx(w1, {}) }),
              v.jsx(pl, { path: '/cart', element: v.jsx(i_, {}) }),
              v.jsx(pl, { path: '/favorites', element: v.jsx(rS, {}) }),
              v.jsx(pl, {
                path: '/:category/:productId',
                element: v.jsx(yS, {}),
              }),
              v.jsx(pl, { path: '*', element: v.jsx(s_, {}) }),
            ],
          }),
        }),
        v.jsx(t1, {}),
  ...
  bS = ({ children: a }) => {
    const [r, s] = N.useState([]),
      i = (y) => `${y.itemId}_${y.color}_${y.capacity}`,
      c = (y) => {
        const A = i(y);
        s((S) =>
          S.find((T) => T.itemUniqueId === A) ?
            S.map((T) =>
              T.itemUniqueId === A ? { ...T, quantity: T.quantity + 1 } : T,
            )
          : [...S, { ...y, quantity: 1, itemUniqueId: A }],
        );
      },
      f = (y) => {
        s((A) => A.filter((S) => S.itemUniqueId !== y));
      },
      h = (y, A) => {
        if (A <= 0) {
          f(y);
        ...
        s((S) =>
          S.map((j) => (j.itemUniqueId === y ? { ...j, quantity: A } : j)),
        );
      },
      g = () => s([]),
      d = N.useCallback(
        () =>
          r.reduce(
            (y, A) => y + (A.priceDiscount ?? A.priceRegular) * A.quantity,
            0,
          ),
        [r],
      ),
      p = N.useCallback(() => r.reduce((y, A) => y + A.quantity, 0), [r]),
      b = (y) => {
        const A = i(y);
        return r.some((S) => S.itemUniqueId === A);
      };
...
$g.createRoot(document.getElementById('root')).render(
  v.jsx(hy, { children: v.jsx(bS, { children: v.jsx(_S, {}) }) }),
);
